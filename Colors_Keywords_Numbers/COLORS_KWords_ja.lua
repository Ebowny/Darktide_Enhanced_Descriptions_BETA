...
-- COLORS_KWords_ja.Ability_cd_rgb_ja
-- COLORS_KWords_ja.Cd_rgb_ja
-- COLORS_KWords_ja.Combat_ability_rgb_ja
...
local function create_colored_keywords(config)
	...
	for color_setting, keywords in pairs(config) do
		...
		for name, text in pairs(keywords) do
			result[name .. "_rgb_ja"] = iu_actit(text, color)
		end
	end
