...
-- COLORS_KWords_pt_br.Ability_cd_rgb_pt_br
-- COLORS_KWords_pt_br.Cd_rgb_pt_br
-- COLORS_KWords_pt_br.Combat_ability_rgb_pt_br
...
local function create_colored_keywords(config)
	...
	for color_setting, keywords in pairs(config) do
		...
		for name, text in pairs(keywords) do
			result[name .. "_rgb_pt_br"] = iu_actit(text, color)
		end
	end
...
local function validate_all()
	...
	for color_setting, items in pairs(CONFIG) do
		for name, _ in pairs(items) do
			...
			local var_name = name .. "_rgb_pt_br"
