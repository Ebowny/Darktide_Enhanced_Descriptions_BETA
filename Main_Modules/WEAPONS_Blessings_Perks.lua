...
--[+ ++WEAPON BLESSINGS - БЛАГОСЛОВЕНИЯ ОРУЖИЯ - 武器祝福++ +]--
	--[+ MELEE - БЛИЖНИЙ БОЙ - 近戰 +]--
		...
		["loc_trait_bespoke_armor_penetration_against_staggered_desc"] = { -- rending: +25%, +colors, +note
			...
			-- fr = CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Rending_rgb_fr").." vs les Enemies qui "..CKWord("", "Staggered_rgb_fr").." "..CNote("Rend_note_rgb_fr"),
			...
			-- ["zh-cn"] = "对抗"..CKWord("", "Staggered_rgb_zh_cn").."敌人时 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Rending_rgb_zh_cn").."。"..CNote("Rend_note_rgb_zh_cn"), --机会主义者
		},
		...
		["loc_trait_bespoke_bleed_on_activated_hit_desc"] = { -- stacks: +14, +colors
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." Cumuls de "..CKWord("", "Bleed_rgb_fr").." lors des attaques spéciales. Jusqu'à "..CNumb("16", "n_16_rgb").." Cumuls.",
			-- ["zh-tw"] = "特殊攻擊時，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("Bleed", "Bleed_rgb_tw").."。\n上限 "..CNumb("16", "n_16_rgb").." 層。", -- 放血者
				-- 突擊鏈斧 -- 10 | 12 | 14 | 16
				-- 突擊鏈鋸劍 -- 11 | 12 | 13 | 14
				-- 重型開膛劍 -- 3 | 4 | 5 | 6
			-- ["zh-cn"] = "特殊攻击 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("", "Bleed_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层。", -- 放血者
		},
		...
		["loc_trait_bespoke_guaranteed_melee_crit_on_activated_kill_desc"] = { -- crit_chance: +100%, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_fr").." sur votre prochaine attaque de mêlée après une élimination avec une attaque spéciale.",
			-- ["zh-tw"] = "在特殊攻擊擊殺敵人後，\n下一次近戰攻擊 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Crit_chance", "Crit_chance_rgb_tw").."。", -- 嗜血
				-- 突擊鏈斧, 突擊鏈鋸劍, 重型開膛劍, 烈焰力場劍 -- 40% | 60% | 80% | 100%
			-- ["zh-cn"] = "特殊攻击击杀敌人时，\n使下次近战攻击 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。", -- 嗜血
		},
		...
		["loc_trait_bespoke_increase_power_on_hit_desc"] = { -- power_level: +5%, time: 3.5, stacks: 5, s->seconds, +colors, +note
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_fr").." pour "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un coup. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "每層 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，可持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n每次攻擊可疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CNote("Pwr_note_rgb_tw"), -- 奪顱者
				-- 突擊鏈斧, 戰鬥斧, 十字鎬, 戰術斧, 雷鎚 -- 3.5% 4% 4.5% 5% (up to +25%)
				-- 重劍 -- 6.5% 7% 7.5% 8% (up to +40%)
			-- ["zh-cn"] = "命中时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。\n攻击每命中一个目标叠加 "..CNumb("1", "n_1_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 夺颅者
		},
		...
		["loc_trait_bespoke_increase_power_on_kill_desc"] = { -- power_level: +5%, time: 4.5, stacks: 5, s->seconds, +colors, +added info, +note
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_fr").." pour "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une élimination. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			--??? ["zh-tw"] = "擊殺敵人時 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，可持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n每次擊殺可疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CNote("Pwr_note_rgb_tw"), -- 殺戮者
			--??? ["zh-tw"] = "每層 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，可持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n每次擊殺可疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CNote("Pwr_note_rgb_tw"), -- 殺戮者
				-- 突擊鏈斧, 砍刀, 輾壓者, 烈焰力場劍, 十字鎬, 動力劍, 雷鎚 -- 5% | 6% | 7% | 8% (up to +40%)
			-- ["zh-cn"] = "击杀敌人时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 屠宰者
		},
		...
		["loc_trait_bespoke_power_bonus_based_on_charge_time_desc"] = { -- power_level: +5%, stacks: 3, +colors, +note
			...
			-- fr = "Jusqu'à "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_fr").." selon le temps de charge de vos attaques puissantes. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "根據重攻擊的續力時間增加 "..CKWord("Strength", "Strength_rgb_tw").." ，\n每層 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，最多可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。CNote("Pwr_note_rgb_tw"), -- 推進
				-- 惡棍棒, 突擊鏈斧, 砍刀, 戰鬥斧, 輾壓者, 決鬥劍, 重劍, 廁所鏟, 十字鎬, 動力劍, 工兵鏟, 電擊錘, 雷鎚 -- 5% | 10% | 15% | 20% (up to +60%)
			-- ["zh-cn"] = "随重攻击蓄力时间增加叠加层数，\n每层 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 助推
		},
		...
		["loc_trait_bespoke_targets_receive_rending_debuff_desc"] = { -- stacks: 4, rending: 2.5%, time: 5, max_stacks: 16, rewrited, +colors, +added info, +note
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." Cumuls de "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Brittleness_rgb_fr").." sont appliqué lors d'un coup sur un ennemie. Pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes. Jusqu'à "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." cumuls, pour un total de "..CNumb("40%", "pc_40_rgb").."."..CKWord("", "Brtl_note_rgb_fr"),
			...
			-- ["zh-cn"] = "命中时，对目标施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Brittleness_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层，最高 "..CNumb("40%", "pc_40_rgb").." 。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 雷鸣
		},
		--[+ WRATH +]--	08.12.2025
		...
		["loc_trait_bespoke_chained_hits_increases_cleave_desc"] = { -- cleave: +40%, stacks: 5, +colors, +added info
			...
			-- fr = CNumb("{cleave:%s}", "cleave_var_rgb").." "..CKWord("", "Cleave_rgb_fr").." lors d'un coup pendant "..CNumb("3.5", "n_3_5_rgb").." secondes. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = "连锁攻击命中时 "..CNumb("{cleave:%s}", "cleave_var_rgb").." "..CKWord("", "Cleave_rgb_zh_cn").."，\n持续 "..CNumb("3.5", "n_3_5_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。", -- 怒火
		},
	--[+ SHRED +]--	08.12.2025
		...
		["loc_trait_bespoke_chained_hits_increases_crit_chance_desc"] = { -- crit_chance: +4%, stacks: 5, +colors, +added info
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." lors d'un coup en chaîne pendant "..CNumb("3.5", "n_3_5_rgb").." secondes. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = "连锁攻击命中时\n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." 近战"..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("3.5", "n_3_5_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。", -- 撕碎
		},
		...
		["loc_trait_bespoke_increased_attack_cleave_on_multiple_hits_desc"] = { -- multiple_hit: 3, cleave: +200%, time: 2, +colors, +added info
			...
			-- fr = CNumb("{cleave:%s}", "cleave_var_rgb").." de "..CKWord("", "Cleave_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes en touchant au moins "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." ennemies avec une attaque.",
			...
			-- ["zh-cn"] = "命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 名敌人时 \n"..CNumb("{cleave:%s}", "cleave_var_rgb").." "..CKWord("", "Cleave_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 野蛮扫荡
		},
		--[+ RAMPAGE +]--	08.12.2025
		...
		["loc_trait_bespoke_increased_melee_damage_on_multiple_hits_desc"] = { -- multiple_hit: 3, damage: 36%, time: 3, Damage -> Strength, +colors, +added info, +note
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de bonus à votre "..CKWord("", "Strength_rgb_fr").." pour vos attaques de mélées pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes en touchant au moins "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." ennemies avec une attaque."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 名敌人 \n"..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 狂暴
		},
		...
		["loc_trait_bespoke_infinite_melee_cleave_on_crit_desc"] = { -- hit_mass: +80%, time: 5, +colors, +added info
			...
			-- fr = CNumb("{hit_mass:%s}", "hitmass_var_rgb").." de "..CKWord("", "Cleave_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un "..CKWord("", "Crit_hit_rgb_fr")..".",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").."时 "..CNumb("{hit_mass:%s}", "hitmass_var_rgb").." "..CKWord("", "Cleave_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 毁灭打击
		},
		...
		["loc_trait_bespoke_chained_hits_increases_power_desc"] = { -- power_level: +5%, stacks: 10, Power -> Strength, +colors, +added info, +note
			en = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb").." on chaining "..CNumb("2", "n_2_rgb")..CKWord("+", "n_plus_rgb").." attacks. Stacks "..CNumb("{stacks:%s}", "stacks_var_rgb").." times. "
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." en enchaînant continuellement plus de "..CNumb("2", "n_2_rgb").." attaques. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "攻擊任意目標超過 "..CNumb("2", "n_2_rgb").." 次時 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，\n每次攻擊可疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。\n需連續命中不得揮空。"..CNote("Pwr_note_rgb_tw"), -- 屠戮者
			-- 戰鬥斧, 工兵鏟, 戰術斧 -- 2% | 3% | 4% | 5% (up to +50%)
			-- ["zh-cn"] = "连锁攻击命中 "..CNumb("2", "n_2_rgb").." 次时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 屠戮者
		},
		...
		["loc_trait_bespoke_infinite_cleave_on_weakspot_kill_desc"] = { -- weakspot_damage: 15%, +colors, +added info
			...
			-- fr = CNumb("{weakspot_damage:%s}", "wkspdmg_var_rgb").." "..CKWord("", "Weakspot_dmg_rgb_fr")..". Les élimination sur "..CKWord("", "Weakspot_rgb_fr").." ignore le "..CKWord("", "Hit_mass_rgb_fr").." de "..CNumb("3", "n_3_rgb").." ennemies.",
			...
			-- ["zh-cn"] = CNumb("{weakspot_damage:%s}", "wkspdmg_var_rgb").." "..CKWord("", "Weakspot_dmg_rgb_zh_cn").."。\n"..CKWord("", "Weakspothits_k_rgb_zh_cn").."无视 "..CNumb("3", "n_3_rgb").." 名敌人的"..CKWord("", "Hit_mass_rgb_zh_cn").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 野蛮势头
		},
		...
		["loc_trait_bespoke_power_bonus_on_first_attack_desc"] = { -- power_level: +60%, cooldown: 3.5, +colors, +note
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." sur votre première attaque toute les "..CNumb("{cooldown:%s}", "cd_var_rgb").." secondes."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "每 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒，首次攻击 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。"..CNote("Pwr_note_rgb_zh_cn"), -- 断肢者
		},
		...
		["loc_trait_bespoke_power_bonus_scaled_on_stamina_desc"] = { -- power_level: +8%, rewrited, +colors, +note
			...
			-- fr = "Jusqu'à "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr")..", en fonction "..CKWord("", "Stamina_rgb_fr").." épuisée. Chaque "..CNumb("20%", "pc_20_rgb").." de la barre d'"..CKWord("", "Stamina_rgb_fr").." épuisée donne "..CNumb("1", "n_1_rgb").." cumule. Jusqu'à "..CNumb("5", "n_5_rgb").." cumuls. {#color(255, 35, 5)}(bug: Les pelles et haches tactiques donnent +10% peu importe le tier de la bénédiction){#reset()}"..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "每消耗最大 "..CKWord("Stamina", "Stamina_rgb_tw").." 的 "..CNumb("20%", "pc_20_rgb").." 獲得一層。\n每一層 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").." ，上限 "..CNumb("5", "n_5_rgb").." 層。\n{#color(255, 35, 5)}(bug: 鏟子和戰術斧 +10% 所有等級){#reset()}"..CNote("Pwr_note_rgb_tw"), -- 孤注一擲
				-- 戰鬥斧, 十字鎬 -- 5% | 6% | 7% | 8% (up to +40%)
				-- 工兵鏟, 戰術斧 -- 一般力量: 10% | 10% | 10% | 10% (up to +50%) (bugged)
			-- ["zh-cn"] = "随"..CKWord("", "Stamina_rgb_zh_cn").."消耗叠加层数，\n每消耗 "..CNumb("20%", "pc_20_rgb").."，"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("5", "n_5_rgb").." 层。{#color(255, 35, 5)}\n（BUG：无论祝福级别如何，战术斧与工兵铲数值始终为 +10% 强度。）{#reset()}"..CNote("Pwr_note_rgb_zh_cn"), -- 孤注一掷
		},
		...
		["loc_trait_bespoke_stacking_rending_on_one_hit_kills_desc"] = { -- finesse: +24%, time: 5, stacks: 5, s->seconds, +colors, +note
			...
			-- fr = CNumb("{finesse:%s}", "fin_var_rgb").." de "..CKWord("", "Finesse_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lorsque l'ennemie est tué en un coup. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Fns_note_rgb_fr"),
			-- ["zh-tw"] = "一擊斃命時 "..CNumb("{finesse:%s}", "fin_var_rgb").." "..CKWord("Finesse", "Finesse_rgb_tw").." ，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n每次擊殺可疊加一層，上限 "..CNumb("5", "n_5_rgb").." 層。"..CNote("Fns_note_rgb_tw"), -- 斬首者
				-- 戰鬥斧 -- 18% | 20% | 22% | 24% (up to +120%)
			-- ["zh-cn"] = "一击毙敌时 "..CNumb("{finesse:%s}", "fin_var_rgb").." "..CKWord("", "Finesse_dmg_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Fns_note_rgb_zh_cn"), -- 斩首者
		},
		--[+ AGILE +]--	08.12.2025
		-- Melee Weakspot Damage (per tier)
		...
		["loc_trait_bespoke_dodge_count_reset_on_weakspot_hit_and_weakspot_damage_desc"] = { -- melee_weakspot_damage: +10%, +colors
			...
			-- fr = CNumb("{melee_weakspot_damage}", "mel_weapsp_dmg_var_rgb").." de "..CKWord("", "Weakspot_dmg_rgb_fr").." de mélée. Actualise l'efficacité de l'esquive lors d'un "..CKWord("", "Weakspothit_rgb_fr")..".",
			...
			-- ["zh-cn"] = CNumb("{melee_weakspot_damage}", "mel_weapsp_dmg_var_rgb").." "..CKWord("", "Weakspot_dmg_rgb_zh_cn").."。\n"..CKWord("", "Weakspothit_rgb_zh_cn").."时，刷新有效闪避。", -- 敏捷
		},
		...
		["loc_trait_bespoke_guaranteed_melee_crit_after_crit_weakspot_kill_new_desc"] = { -- crit_chance: +100%, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pour la prochaine attaque de mélée dans les "..CNumb("5", "n_5_rgb").." secondes suivant une élimination sur "..CKWord("", "Weakspot_rgb_fr").." et "..CKWord("", "Crit_rgb_fr")..".",
			-- ["zh-tw"] = "在 "..CKWord("Weakspot", "Weakspot_rgb_tw").." "..CKWord("Crit_k", "Crit_k_rgb_tw").." 後的 "..CNumb("5", "n_5_rgb").." 秒內，\n下一次近戰攻擊必定 "..CKWord("Crit", "Crit_rgb_tw").." 。", -- 殺戮狂潮
				-- 戰術斧 -- 40% | 60% | 80% | 100%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspot_rgb_zh_cn")..""..CKWord("", "Crit_hits_k_rgb_zh_cn").."时，下次近战攻击 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("5", "n_5_rgb").." 秒。", -- 屠杀狂欢
		},
		...
		["loc_trait_bespoke_power_bonus_on_same_enemy_attacks_desc"] = { -- power_level: +10%, time: 2, stacks: 5, s->seconds, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes en attaquant le même ennemie. Se Cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "命中同一敵人 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，持續"..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。"..CNote("Pwr_note_rgb_tw"), -- 持續打擊
				-- 決鬥劍, 戰術斧 -- 4% | 6% | 8% | 10% (up to +50%)
			-- ["zh-cn"] = "再次命中同一敌人时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 无情打击
		},
		...
		["loc_trait_bespoke_bleed_on_crit_melee_desc"] = { -- stacks: +8, +colors
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." Cumuls de "..CKWord("", "Bleed_rgb_fr").." en cas de "..CKWord("", "Crit_hit_rgb_fr")..". Jusqu'à "..CNumb("16", "n_16_rgb").." Cumuls.",
			-- ["zh-tw"] = "在暴擊時，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("Bleed", "Bleed_rgb_tw").." 。\n上限 "..CNumb("16", "n_16_rgb").." 層。", -- 血肉撕裂者
				-- 戰刃 -- 5 | 6 | 7 | 8
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").."时 ".. CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("", "Bleed_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层。", -- 撕裂者
		},
		--[+ LACERATE +]--	08.12.2025
		...
		["loc_trait_bespoke_bleed_on_non_weakspot_hit_desc"] = { -- stacks: +4, +colors
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." Cumuls de "..CKWord("", "Bleed_rgb_fr").." sur les attaque hors "..CKWord("", "Weakspothits_rgb_fr")..". Jusqu'à "..CNumb("16", "n_16_rgb").." Cumuls.",
			-- ["zh-tw"] = "非 "..CKWord("Weakspothits", "Weakspothits_rgb_tw").." 時，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("Bleed", "Bleed_rgb_tw").." 。\n上限 "..CNumb("16", "n_16_rgb").." 層。", -- 撕碎
				-- 戰刃 -- 1 | 2 | 3 | 4
			-- ["zh-cn"] = "非"..CKWord("", "Weakspothits_rgb_zh_cn").."时 ".. CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("", "Bleed_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层。", -- 割裂
		},
		--[+ EXECUTOR +]--	08.12.2025
		-- Power per stack (per tier)
		...
		["loc_trait_bespoke_chained_weakspot_hits_increases_power_desc"] = { -- power_level: +6%, stacks: 5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." lors d'un coup sur "..CKWord("", "Weakspothit_rgb_fr").." répété. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois. {#color(255, 35, 5)}(bug:+5% sur tout les niveaux de bénédiction){#reset()}"..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "命中 "..CKWord("Weakspothit", "Weakspothit_rgb_tw").." 時 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").."	秒。\n持續命中時每次疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CNote("Pwr_note_rgb_tw"), -- 行刑者
				-- 戰刃, 烈焰力場劍 -- 5% | 5% | 5% | 5% (up to +25%) (bugged)
			-- ["zh-cn"] = "连续"..CKWord("", "Weakspothit_rgb_zh_cn").."时"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。{#color(255, 35, 5)}\n（BUG：无论祝福级别如何，数值始终为 +5% 强度。）{#reset()}"..CNote("Pwr_note_rgb_zh_cn"), -- 处刑者
		},
		--[+ RIPOSTE +]--	08.12.2025
		-- Crit Chance (per tier)
		...
		["loc_trait_bespoke_dodge_grants_crit_chance_desc"] = { -- crit_chance: +20%, time: 6, s->seconds, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une esquive réussie.",
			...
			-- ["zh-cn"] = "成功闪避时 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." 近战"..CKWord("", "Crit_chance_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 还击
		},
		...
		["loc_trait_bespoke_dodge_grants_finesse_bonus_desc"] = { -- damage: +60%, time: 2, s->seconds, +colors, +note
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." de "..CKWord("", "Finesse_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une esquive réussie."..CNote("Fns_note_rgb_fr"),
			-- ["zh-tw"] = "成功閃躲時 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Finesse_dmg", "Finesse_dmg_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒，"..CNote("Fns_note_rgb_tw"), -- 未卜先知
				-- 戰刃, 決鬥劍, 烈焰力場劍, 烈焰力場巨劍 -- 45% | 50% | 55% | 60%
			-- ["zh-cn"] = "成功闪避时 "..CNumb("{damage:%s}", "dmg_var_rgb").." 近战"..CKWord("", "Finesse_dmg_rgb_zh_cn").."".."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Fns_note_rgb_zh_cn"), -- 预知
		},
		--[+ HAYMAKER +]--	08.12.2025
		...
		["loc_trait_bespoke_increased_crit_chance_after_punching_staggered_enemy_desc"] = { -- crit_chance: +20%, time: 2, s->seconds, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes pendant qu'un ennemie "..CKWord("", "Staggered_rgb_fr").." grâce à un coup d'action spéciale.",
			...
			-- ["zh-cn"] = "特殊攻击命中"..CKWord("", "Staggered_rgb_zh_cn").."敌人时 \n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." 近战"..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 攻击波
		},
		...
		["loc_trait_bespoke_increased_weakspot_damage_on_bleeding_desc"] = { -- damage: +60%, +colors
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("", "Weakspot_dmg_rgb_fr").." au ennemies avec des cumuls de "..CKWord("", "Bleed_rgb_fr")..".",
			-- ["zh-tw"] = "攻擊有 "..CKWord("Bleed", "Bleed_rgb_tw").." 的敵人，\n增加 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Weakspot_dmg", "Weakspot_dmg_rgb_tw").." 。", -- 仁慈殺手
				-- 戰刃 -- 52.5% | 55% | 57.5% | 60%
			-- ["zh-cn"] = "对"..CKWord("", "Bleed_rgb_zh_cn").."敌人 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("", "Weakspot_dmg_rgb_zh_cn").."。", -- 仁慈杀手
		},
		--[+ RUTHLESS BACKSTAB +]--
		...
		["loc_trait_bespoke_rending_on_backstabs_desc"] = { -- rending: +100%, +colors
			...
			-- fr = CNumb("{rending:%s}", "rending_var_rgb").." de "..CKWord("", "Rending_rgb_fr").." lors d'un coup dans le dos."..CNote("Rend_note_rgb_fr"),
			-- ["zh-tw"] = "背刺時，增加 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Rending", "Rending_rgb_tw").." 。", -- 無情背刺
				-- 戰刃 -- 70% | 80% | 90% | 100%
			-- ["zh-cn"] = "背刺时 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Rending_rgb_zh_cn").."。"..CNote("Rend_note_rgb_zh_cn"), -- 无情背刺
		},
		...
		["loc_trait_bespoke_stacking_rending_on_weakspot_desc"] = { -- rending: +24%, time: 3.5, stacks: 5, s->seconds, +colors
			...
			-- fr = CNumb("{rending:%s}", "rending_var_rgb").." de "..CKWord("", "Rending_rgb_fr").." sur un coup sur "..CKWord("", "Weakspothit_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Rend_note_rgb_fr"),
			-- ["zh-tw"] = CKWord("Weakspothit", "Weakspothit_rgb_tw").." 時 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Rending", "Rending_rgb_tw").." ，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒，\n每次攻擊可疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CNote("Rend_note_rgb_tw"), -- 詭異打擊
				-- 戰刃, 決鬥劍, 烈焰力場劍, 工兵鏟 -- 12% | 16% | 20% | 24% (up to +120%)
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothit_rgb_zh_cn").."时 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Rending_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加"..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Rend_note_rgb_zh_cn"), -- 神秘打击
		},
		--[+ TRAUMA +]--
		...
		["loc_trait_bespoke_consecutive_hits_increases_stagger_desc"] = { -- impact: +20%, time: 2, stacks: 5, +colors
			...
			-- fr = CNumb("{impact:%s}", "impact_var_rgb").." d'"..CKWord("", "Impact_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un coup répété. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
		...
		["loc_trait_bespoke_increase_stagger_per_hit_in_sweep_desc"] = { -- impact: +20%, +colors
			...
			-- fr = CNumb("{impact:%s}", "impact_var_rgb").." d'"..CKWord("", "Impact_rgb_fr").." à la cible pour chaque ennemie déjà touché par la même attaque. Jusqu'à "..CNumb("5", "n_5_rgb").." cumuls.",
			...
			-- ["zh-cn"] = "每有一个已被同一攻击命中的敌人，\n"..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."。最多叠加 "..CNumb("5", "n_5_rgb").." 层。", -- 邪恶斩切
		},
		--[+ HAMMERBLOW +]--
		-- Melee Stagger Strength per stack (per tier)
		...
		["loc_trait_bespoke_stacking_increase_impact_on_hit_desc"] = { -- impact: +25%, time: 1.5, stacks: 5, s->seconds, +colors
			...
			-- fr = CNumb("{impact:%s}", "impact_var_rgb").." d'"..CKWord("", "Impact_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un coup. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois. Jusqu'à "..CNumb("5", "n_5_rgb").." cumuls par coup.",
			...
			-- ["zh-cn"] = "命中时 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。\n攻击每命中一个目标叠加 "..CNumb("1", "n_1_rgb").." 层。", -- 锤击
		},
		--[+ SKULLCRUSHER +]--
		...
		["loc_trait_bespoke_staggered_targets_receive_increased_damage_debuff_desc"] = { -- stacks: 4, damage: +10%, time: 5, Stack(s)->Stacks, +colors
			...
			-- fr = "La cible subit "..CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." si elle "..CKWord("", "Staggered_rgb_fr").." déjà, jusqu'à un maximum de "..CNumb("8", "n_8_rgb").." cumuls. Dure "..CNumb("{time:%s}", "time_var_rgb").." secondes.",
			...
			-- ["zh-cn"] = "对"..CKWord("", "Staggered_rgb_zh_cn").."敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("伤害", "Damage_rgb_zh_cn").."效果，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("8", "n_8_rgb").." 层。", -- 碎颅者
		},
		--[+ THUNDERSTRIKE +]--
		-- Debuff Stacks Applied (per tier)
		...
		["loc_trait_bespoke_staggered_targets_receive_increased_stagger_debuff_desc"] = { -- stacks: 4, impact: +10%, time: 5, Stack(s)->Stacks, +colors
			...
			-- fr = "La cible subit "..CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CNumb("{impact:%s}", "impact_var_rgb").." d'"..CKWord("", "Impact_rgb_fr").." si elle "..CKWord("", "Staggered_rgb_fr").." déjà, jusqu'à un maximum de "..CNumb("8", "n_8_rgb").." cumuls. Dure "..CNumb("{time:%s}", "time_var_rgb").." secondes.",
			...
			-- ["zh-cn"] = "对"..CKWord("", "Staggered_rgb_zh_cn").."敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."效果，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("8", "n_8_rgb").." 层。", -- 雷击
		},
		--[+ CHAINED DEATHBLOW +]--
		-- Melee Crit Chance (per tier)
		...
		["loc_trait_bespoke_increased_crit_chance_on_weakspot_kill_desc"] = { -- crit_chance: +20%, time: 3, s->seconds, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une élimination sur "..CKWord("", "Weakspot_rgb_fr")..". {#color(255, 35, 5)}(bug:+10% de taux de coup critique peu importe le niveau de la bénédiction){#reset()}",
			-- ["zh-tw"] = CKWord("Weakspot", "Weakspot_rgb_tw").." 擊殺時 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Crit_chance", "Crit_chance_rgb_tw").."。\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。{#color(255, 35, 5)}\n(bug: 所有等級 +10%){#reset()}", -- 致命連擊
				-- 重劍 -- 5% | 10% | 15% | 20%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothits_k_rgb_zh_cn").."时 \n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。{#color(255, 35, 5)}\n（存在BUG：无论祝福级别如何，数值始终为 +10% 暴击几率。）{#reset()}", -- 连锁死亡打击
		},
		--[+ PERFECT STRIKE +]--
		...
		["loc_trait_bespoke_pass_past_armor_on_crit_new_desc"] = { -- crit_damage: +10%, +colors
			...
			-- fr = CNumb("{crit_damage:%s}", "critdmg_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." de "..CKWord("", "Crit_hit_rgb_fr").." en mélée. Les "..CKWord("", "Crit_hits_rgb_fr").." ignore le "..CKWord("", "Hit_mass_rgb_fr").." de l'armure.",
			...
			-- ["zh-cn"] = "近战"..CKWord("", "Crit_hit_rgb_zh_cn").."时 "..CNumb("{crit_damage:%s}", "critdmg_var_rgb")..COLORS_KWords_zh_cn.Damage_rgb_zh_cn").."。\n"..CKWord("", "Crit0_rgb_zh_cn").."同时无视装甲赋予的"..CKWord("", "Hit_mass_rgb_zh_cn").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 完美打击
		},
		--[+ BLADED MOMENTUM +]--
		-- Rending per stack (per tier)
		...
		["loc_trait_bespoke_stacking_rending_on_cleave_desc"] = { -- rending: +10%, time: 2.5, stacks: 5, +colors, +note
			...
			-- fr = CNumb("{rending:%s}", "rending_var_rgb").." de "..CKWord("", "Rending_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un coup en mélée multiple . Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Rend_note_rgb_fr"),
			...
			-- ["zh-cn"] = "命中多名敌人时"..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Rending_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Rend_note_rgb_zh_cn"), -- 刀刃势头
		},
		--[+ DEFLECTOR +]--
		...
		["loc_trait_bespoke_toughness_recovery_on_multiple_hits_desc"] = { -- toughness: 15%, multiple_hit: 3, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de régénération de "..CKWord("", "Toughness_rgb_fr").." en touchant au moins "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." ennemies avec une attaque.",
			...
			-- ["zh-cn"] = "命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 名敌人时，\n"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。", -- 动量
		},
		...
		["loc_trait_bespoke_vent_warp_charge_on_multiple_hits_desc"] = { -- multiple_hit: 3, warp_charge: 2%, +colors
			...
			-- fr = "Toucher au moins "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." ennemies avec une attaque, réduit de "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." le "..CKWord("", "Peril_rgb_fr")..".",
			-- ["zh-tw"] = "在一次攻擊命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 個敵人時，\n消除 "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." 點的 "..CKWord("Peril", "Peril_rgb_tw").." 。", -- 兇殘之寧
				-- 烈焰力場巨劍 -- 2% | 3% | 4% | 5% ???
			-- ["zh-cn"] = "命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 名敌人时，\n平息 " ..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." "..CKWord("", "Peril_rgb_zh_cn").."。", -- 杀意如水
		},
		...
		["loc_trait_bespoke_warp_burninating_on_crit_desc"] = { -- stacks: +4, max_stacks: 12, Stack(s)->Stacks, +colors
			...
			-- fr = "L'ennemi gagne "..CKWord("+", "n_plus_rgb")..""..CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls d'"..CKWord("", "Soulblaze_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr")..", Jusqu'à "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." cumuls.",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").."时, 对敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("", "Soulblaze_rgb_zh_cn").."。最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 次。", -- 烈焰之魂
		},
		--[+ UNSTABLE POWER +]--
		-- Power per stack (per tier)
		...
		["loc_trait_bespoke_warp_charge_power_bonus_desc"] = { -- power_level: +20%, +colors
			...
			-- fr = "Jusqu'à "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_fr")..", en fonction du "..CKWord("", "Peril_rgb_fr")..". Se cumule "..CNumb("4", "n_4_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = CKWord("Peril", "Peril_rgb_tw").." 每增加"..CNumb("20%", "pc_20_rgb").."， 獲得一層，\n每一層 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").." ，上限 "..CNumb("4", "n_4_rgb").." 層。"..CNote("Pwr_note_rgb_tw"), -- 不穩定能量
			-- 烈焰力場巨劍, 烈焰力場劍 -- 3.5% | 4% | 4.5% | 5% (up to +20%)
			-- ["zh-cn"] = "随"..CKWord("", "Peril_rgb_zh_cn").."增长叠加层数，\n每增长 "..CNumb("20%", "pc_20_rgb").."，"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("4", "n_4_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 无常之力
		},
		--[+ WARP SLICE +]--
		-- Cooldown (per tier)
		...
		["loc_trait_bespoke_chained_weakspot_hits_vents_warpcharge_desc"] = { -- warp_charge: 5%, +colors
			...
			-- fr = CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." du "..CKWord("", "Peril_rgb_fr").." est dissipé sur les "..CKWord("", "Weakspothit_rgb_fr").." répété.",
			-- ["zh-tw"] = "連續 "..CKWord("Weakspothit", "Weakspothit_rgb_tw").." 時，消除 "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." "..CKWord("Peril", "Peril_rgb_tw").." 。", -- 驅魔者
				-- 烈焰力場劍 -- 2% | 3% | 4% | 5%
			-- ["zh-cn"] = "连锁攻击"..CKWord("", "Weakspothit_rgb_zh_cn").."时，\n平息 "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." "..CKWord("", "Peril_rgb_zh_cn").."。", -- 驱魔者
		},
		...
		["loc_trait_bespoke_elite_kills_grants_stackable_power_desc"] = { -- stacks: 5, power_level: +12.5%, time: 7, s->seconds, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une élimination d'élite. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois. Les cumuls se détériorent un à un."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "擊殺精英時，增加 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n每次擊殺可疊加一層，上限 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CNote("Pwr_note_rgb_tw"), -- 優勢
				-- 烈焰力場劍 -- 5% | 7.5% | 10% | 12.5% (up to +37.5%)
			-- ["zh-cn"] = "击杀精英敌人时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层，该效果逐层衰减。"..CNote("Pwr_note_rgb_zh_cn"), -- 优势
		},
		--[+ LIGHTNING REFLEXES +]--
		-- Melee Power (per tier)
		...
		["loc_trait_bespoke_block_has_chance_to_stun_with_cd_desc"] = { -- power_level: 25%, duration: 3, cooldown_duration: 3, +colors
			...
			-- fr = "Les blocages opportuns "..CKWord("", "Stun_s_rgb_fr").." l'attaquant et vous octroient "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." de mélée pendant "..CNumb("{duration:%s}", "dur_var_rgb").." secondes. Temps de recharge : "..CNumb("{cooldown_duration:%s}", "cd_dur_var_rgb").." secondes."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = ("完美格擋會使攻擊者 "..CKWord("Staggers", "Staggers_rgb_tw").." ，\n並 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近戰 "..CKWord("Strength", "Strength_rgb_tw").."，持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。\n冷卻時間為 "..CNumb("{cooldown_duration:%s}", "cd_dur_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 閃電反射
					-- 電擊錘
			-- ["zh-cn"] = "完美格挡会使目标"..CKWord("", "Electrocute_rgb_zh_cn").."，\n同时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近战"..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。\n冷却时间 "..CNumb("{cooldown_duration:%s}", "cd_dur_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 闪电反应
		},
		--[+ HIGH VOLTAGE +]--
		...
		["loc_trait_bespoke_damage_bonus_vs_electrocuded_desc"] = { -- damage: +25%, +colors
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." contre les ennemies "..CKWord("", "Electrocuted_rgb_fr").." .",
			-- ["zh-tw"] = "對 "..CKWord("Electrocuted", "Electrocuted_rgb_tw").." 的敵人 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Damage", "Damage_rgb_tw").." 。", -- 高壓電
				-- 電擊錘 -- 10% | 15% | 20% | 25%
			-- ["zh-cn"] = "对"..CKWord("", "Electrocuted_rgb_zh_cn").."敌人 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("伤害", "Damage_rgb_zh_cn").."。", -- 高压电
		},
		--[+ FALTER +]--
		...
		["loc_trait_bespoke_negate_stagger_reduction_on_weakspot_desc"] = { -- stagger: 90%, ranged_stagger: 30%, +colors
			...
			-- fr = "Le "..CKWord("", "Stagger_rgb_fr").." des ennemis augmente de "..CNumb("{stagger:%s}", "stgr_var_rgb")..", lors d'un "..CKWord("", "Weakspothit_rgb_fr")..". De plus augmente la puissance du "..CKWord("", "Stagger_rgb_fr").." à distance de "..CNumb("{ranged_stagger:%s}", "stgrrang_var_rgb")..".",
			-- ["zh-tw"] = CKWord("Weakspothit", "Weakspothit_rgb_tw").." 時，增加 "..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("Stagger2", "Stagger2_rgb_tw").." ，\n與 "..CNumb("{ranged_stagger:%s}", "stgrrang_var_rgb").." 的遠程 "..CKWord("Stagger2", "Stagger2_rgb_tw").." 。", -- 踉蹌
				-- 電擊錘 -- 60% | 70% | 80% | 90%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothit_rgb_zh_cn").."时，\n对敌人施加的"..CKWord("", "Stagger2_rgb_zh_cn").."效果 "..CNumb("{stagger:%s}", "stgr_var_rgb").."。\n远程武器带有该祝福时，\n额外 "..CNumb("{ranged_stagger:%s}", "stgrrang_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."。", -- 摇摇欲坠
		},
		--[+ OVERWHELMING FORCE +]--
		...
		["loc_trait_bespoke_staggering_hits_has_chance_to_stun_desc"] = { -- chance: 25%, cooldown: 3.5, +colors
			en = CKWord("Staggering", "Staggering_rgb").." an Enemy has a "..CNumb("{chance:%s}", "chnc_var_rgb").." Chance to Stun the enemy. Cooldown "..CNumb("{cooldown:%s}", "cd_var_rgb").." seconds. "
			...
			-- fr = "Faire "..CKWord("", "Staggering_rgb_fr").." un ennemie à "..CNumb("{chance:%s}", "chnc_var_rgb").." de chance de l'"..CKWord("", "Stun_rgb_fr")..". Temps de recharge : "..CNumb("{cooldown:%s}", "cd_var_rgb").." secondes.",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Stagger_rgb_zh_cn").."敌人时 "..CNumb("{chance:%s}", "chnc_var_rgb").." 几率使目标"..CKWord("", "Electrocute_rgb_zh_cn").."。\n冷却时间 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。", -- 迅猛之力
		},
		--[+ COUNTERATTACK +]--
		...
		["loc_chained_weakspot_hits_increase_finesse_and_reduce_overheat_desc"] = { -- buildup_amount: 6%, damage: 4%, duration: 3 , stacks: 5, s->seconds, +colors
			...
			-- fr = "Réduit la génération de "..CKWord("", "Heat_rgb_fr").." de "..CNumb("{buildup_amount:%s}", "buildup_var_rgb").." et augmente les "..CKWord("", "Weakspot_dmg_rgb_fr").." de "..CNumb("{damage:%s}", "dmg_var_rgb").." pendant "..CNumb("{duration:%s}", "dur_var_rgb").." secondes lors de "..CKWord("", "Weakspothit_rgb_fr").." répétés. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothit_rgb_zh_cn").."时 \n"..CNumb("{buildup_amount:%s}", "buildup_var_rgb").." "..CKWord("", "Heat_rgb_zh_cn").."积累，同时 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("", "Finesse_dmg_rgb_zh_cn").."，\n持续 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Fns_note_rgb_zh_cn"), - 人头落地
		},
		...
		["loc_explosion_on_overheat_lockout_desc"] = { -- overheat_reduction: 25%, +colors
			...
			-- fr = "Lorsque vous entrez en état de Verouillage, vous produisez une Explosion autour de vous et réduisez immédiatement la "..CKWord("", "Heat_rgb_fr").." de "..CNumb("{overheat_reduction:%s}", "overheat_red_var_rgb")..".",
			-- ["zh-tw"] = "進入鎖定狀態時，產生爆炸，\n並立即降低 "..CKWord("Heat", "Heat_rgb_tw").." "..CNumb("{overheat_reduction:%s}", "overheat_red_var_rgb").." 。", -- 超載
				-- 上古神刃 -- 10% | 15% | 20% | 25%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Heat_rgb_zh_cn").."达到 "..CNumb("100%", "pc_100_rgb").." 并进入锁定状态时，\n在周身范围引发一次爆炸，\n并立刻减少 "..CNumb("{overheat_reduction:%s}", "overheat_red_var_rgb").." "..CKWord("", "Heat_rgb_zh_cn").."。", -- 过载
		},
		--[+ ENERGY LEAKAGE +]--
		-- Power per stack (per tier)
		...
		["loc_power_bonus_scaled_on_heat_desc"] = { -- amount: 4%, +colors
			...
			-- fr = "Augmente la "..CKWord("", "Strength_rgb_fr").." jusqu'à "..CNumb("{amount}", "amount_var_rgb")..", en fonction de la "..CKWord("", "Heat_rgb_fr").."."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "随"..CKWord("", "Heat_rgb_zh_cn").."增长叠加层数，\n每增长 "..CNumb("20%", "pc_20_rgb").."，"..CNumb("{amount}", "amount_var_rgb").." "..CKWord("", "Power_rgb_zh_cn").."。\n最多叠加 "..CNumb("5", "n_5_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 能量泄露
		},
		--[+ HEATSINK +]--
		-- Overheat Amount Removed (per tier)
		-- Power Falchions, Relic Blades -- 4% | 6% | 8% | 10%
		["loc_reduce_fixed_overheat_amount_desc"] = { -- amount: 10%, time: 3, s->seconds, +colors
			en = CKWord("-", "n_minus_rgb")..CNumb("{amount}", "amount_var_rgb").." "..CKWord("Heat", "Heat_rgb").." over "..CNumb("{time:%s}", "time_var_rgb").." seconds on "..CKWord("Weakspot", "Weakspot_rgb").." or "..CKWord("Critical", "Critical_rgb").." Kills. "
				..CPhrs("Can_be_refr"),
			...
			-- fr = "Les éliminations sur "..CKWord("", "Weakspot_rgb_fr").." et "..CKWord("", "Crit_hits_rgb_fr").." réduisent la "..CKWord("", "Heat_rgb_fr").." de "..CNumb("{amount}", "amount_var_rgb").." sur "..CNumb("{time:%s}", "time_var_rgb").." secondes.",
			-- ["zh-tw"] = CKWord("Weakspot_k_dmg", "Weakspot_k_dmg_rgb_tw").." 和 "..CKWord("Crit_k", "Crit_k_rgb_tw").." ， \n在 "..CNumb("{time:%s}", "time_var_rgb").." 秒內 "..CKWord("Heat", "Heat_rgb_tw").." 減少 "..CNumb("{amount}", "amount_var_rgb"), -- 散熱器 +]--
				-- 上古神刃 -- 4% | 6% | 8% | 10%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothits_k_rgb_zh_cn").."和"..CKWord("", "Crit_hits_k_rgb_zh_cn").."时，\n在 "..CNumb("{time:%s}", "time_var_rgb").." 秒内减少"..CNumb("{amount}", "amount_var_rgb").." "..CKWord("", "Heat_rgb_zh_cn").."。", -- 散热器
		},
		--[+ SYPHON +]--
		-- Max Toughness Percentage (per tier)
		...
		["loc_trait_bespoke_regain_toughness_on_multiple_hits_by_weapon_special_desc"] = { -- toughness: 16%, +colors
			...
			-- fr = "Toucher au moins "..CNumb("3", "n_3_rgb").." ennemis avec une attaque lorsque la forme Spéciale de l'arme est active, restaure "..CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr")..".",
			-- ["zh-tw"] = "在武器充能期間，\n一次攻擊命中至少 "..CNumb("3", "n_3_rgb").." 個敵人時，\n"..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("Toughness", "Toughness_rgb_tw").." 。", -- 虹吸
				-- 上古神刃 -- 10% | 12% | 14% | 16%
			-- ["zh-cn"] = "武器充能期间，\n命中至少 "..CNumb("3", "n_3_rgb").." 名敌人时，"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。", -- 虹吸
		},
		...
		["loc_slower_heat_buildup_on_perfect_block_desc"] = { -- heat_reduction: 20%, heat_dissipation: 5%, time: 5, interval: 8, +colors
			...
			-- fr = "Réduit la génération de "..CKWord("", "Heat_rgb_fr").." de "..CNumb("{heat_reduction:%s}", "heat_red_var_rgb").." et augmente la dissipation de "..CKWord("", "Heat_rgb_fr").." de "..CNumb("{heat_dissipation:%s}", "heat_diss_var_rgb").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un blocage parfait. Ne peux se produire que toute les "..CNumb("{interval:%s}", "interval_var_rgb").." secondes.",
			...
			-- ["zh-cn"] = "完美格挡时"..CNumb("{heat_reduction:%s}", "heat_red_var_rgb").." "..CKWord("", "Heat_rgb_zh_cn").."积累，\n同时 "..CNumb("{heat_dissipation:%s}", "heat_diss_var_rgb").." "..CKWord("", "Heat_rgb_zh_cn").."消散，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n每 "..CNumb("{interval:%s}", "interval_var_rgb").." 秒只能触发一次。", -- 能量转移
		},
		...
		["loc_trait_bespoke_hit_mass_consumption_reduction_on_kill_desc"] = { -- hit_mass: -40%, time: 2, s->seconds, +colors
			...
			-- fr = CNumb("{hit_mass:%s}", "hitmass_var_rgb").." "..CKWord("", "Hit_mass_rgb_fr").." ennemie pour "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une élimination.",
			-- ["zh-tw"] = "擊殺敵人後，敵人 "..CKWord("Hit_masss", "Hit_masss_rgb_tw").." "..CNumb("{hit_mass:%s}", "hitmass_var_rgb").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 震懾
				-- 雷鎚 -- 30% | 40% | 50% | 60%
			-- ["zh-cn"] = "击杀敌人时，使敌人 "..CKWord("", "Hit_masss_rgb_zh_cn").." 降至"..CNumb("{hit_mass:%s}", "hitmass_var_rgb").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"),
		},
		--[+ TAKE A SWING +]--
		...
		["loc_trait_bespoke_weakspot_damage_bonus_on_pushed_enemies_desc"] = { -- toughness: +60%, time: 3, +colors
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("", "Weakspot_dmg_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une poussée d'ennemis.",
			-- ["zh-tw"] = "推開敵人後 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Weakspot_dmg", "Weakspot_dmg_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 揮拳出擊
				-- 工兵鏟 -- 45% | 50% | 55% | 60%
			-- ["zh-cn"] = "推搡敌人 \n"..CNumb("{damage:%s}", "dmg_var_rgb").." 近战"..CKWord("", "Weakspot_dmg_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 挥拳出击
		},
		...
		["loc_trait_bespoke_armor_rend_on_activated_attacks_desc"] = { -- rend: +4, +colors
			...
			-- fr = CNumb("{rend:%s}", "rend_var_rgb").." cumuls de "..CKWord("", "Brittleness_rgb_fr").." lors d'un coup énergisé."..CKWord("", "Brtl_note_rgb_fr"),
			-- ["zh-tw"] = "特殊攻擊敵人時，\n使其獲得 "..CNumb("{rend:%s}", "rend_var_rgb").." 層 "..CKWord("Brittleness", "Brittleness_rgb_tw").."，上限 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層。 "..CKWord("Brtl_note", "Brtl_note_rgb_tw"), -- 超級充能
				-- 動力錘, 動力劍 -- 1 | 2 | 3 | 4
			-- ["zh-cn"] = "充能攻击命中时，\n对目标施加 "..CNumb("{rend:%s}", "rend_var_rgb").." 层"..CKWord("", "Brittleness_rgb_zh_cn").."。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 超负荷
		},
		--[+ POWER CYCLER +]--
		...
		["loc_trait_bespoke_extended_activation_duration_and_stagger_on_chained_attacks_desc"] = { -- extra_hits: +2, stagger: +10%, +colors
			en = CKWord("+", "n_plus_rgb")..CNumb("{extra_hits:%s}", "extrahits_var_rgb").." Extra Chained Energised Hits and\n"..CKWord("+", "n_plus_rgb")..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("Impact", "Impact_rgb").." on Energised Hits. "
				..CNote("Impact_note"),
			ru = CKWord("+", "n_plus_rgb")..CNumb("{extra_hits:%s}", "extrahits_var_rgb").." заряда к заряженным ударам и\n"
			...
			-- fr = CNumb("{extra_hits:%s}", "extrahits_var_rgb").." Coups d'énergie en chaîne supplémentaires et "..CNumb("{stagger:%s}", "stgr_var_rgb").." d'"..CKWord("", "Impact_rgb_fr").." lors d'un coup énergisé.",
			-- ["zh-tw"] = "特殊啟動攻擊時 "..CKWord("+", "n_plus_rgb")..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("Impact", "Impact_rgb_tw").." ，\n並獲得 "..CNumb("{extra_hits:%s}", "extrahits_var_rgb").." 次額外充能攻擊次數。", -- 能量循環
				-- 動力劍 -- 5% | 10% | 15% | 20%
			-- ["zh-cn"] = "武器充能期间 "..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."，\n充能连锁攻击时 "..CNumb("{extra_hits:%s}", "extrahits_var_rgb").." 额外充能攻击次数。", -- 能量循环
		},
		--[+ SUNDER +]--
		...
		["loc_trait_bespoke_infinite_armor_cleave_on_activated_attacks_and_heavy_damage_desc"] = { -- heavy_damage: +20%, +colors
			en = "On Energised Attacks:\n"
				...
				..CKWord("-", "n_minus_rgb")..CNumb("75%", "pc_75_rgb").." enemy "..CKWord("Hit Mass", "Hit_mass_rgb").." which increases "..CKWord("Cleave", "Cleave_rgb")..".",
			...
			-- fr = "Lors d'un coup énergisé, augmente le "..CKWord("", "Cleave_rgb_fr").." et les "..CKWord("Dégâts", "Damage_rgb_fr").." des attaques puissantes de mélée de "..CNumb("{heavy_damage:%s}", "dmghvy_var_rgb")..".",
			-- ["zh-tw"] = "充能攻擊時 "..CKWord("Damage_s", "Damage_s_rgb_tw").." "..CNumb("{heavy_damage:%s}", "dmghvy_var_rgb").."，\n並強化 "..CKWord("Cleaving", "Cleaving_rgb_tw").." 。", -- 破甲
				-- 動力劍 -- 5% | 10% | 15% | 20%
			-- ["zh-cn"] = "充能攻击 "..CNumb("{heavy_damage:%s}", "dmghvy_var_rgb").." 近战重攻击"..CKWord("伤害", "Damage_rgb_zh_cn").."，\n同时无视装甲赋予的"..CKWord("", "Hit_mass_rgb_zh_cn").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 切裂
		},
		--[+ SUCKER PUNCH +]--
		-- Melee Crit Chance (per tier)
		...
		["loc_trait_bespoke_increased_crit_chance_after_punch_desc"] = { -- crit_chance: +15%, time: 3, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un coup d'action spéciale.",
			-- ["zh-tw"] = "特殊攻擊命中時 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Crit_chance", "Crit_chance_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 突然襲擊
				-- 廁所鏟 -- 7.5% | 10% | 12.5% | 15%
			-- ["zh-cn"] = "特殊攻击命中敌人时 \n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." 近战"..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 出其不意
		},
		--[+ CONFIDENT STRIKE +]--
		-- Max Toughness Percentage (per tier)
		...
		["loc_trait_bespoke_toughness_recovery_on_chained_attacks_desc"] = { -- toughness: +8%, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("", "Toughness_rgb_fr").." lors d'un coup en chaîne.",
			-- ["zh-tw"] = "連續攻擊時 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("Toughness", "Toughness_rgb_tw").."。", -- 堅定打擊
				-- 作戰大槌and板盾, 惡棍棒, 砍刀, 廁所鏟, 十字鎬, 動力錘 -- 5% | 6% | 7% | 8%
			-- ["zh-cn"] = "连锁攻击命中时，"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。", -- 自信打击
		},
		--[+ NO GUTS, NO GLORY +]--
		-- Duration (per tier)
		...
		["loc_trait_bespoke_toughness_regen_on_punching_elites_desc"] = { -- toughness: +8%,  time: 5, s->seconds, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de régénération de "..CKWord("", "Toughness_rgb_fr").." par seconde pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un coup d'action spéciale sur un élite.",
			...
			-- 惡棍棒 -- 2 | 3 | 4 | 5
			-- ["zh-cn"] = "特殊攻击命中精英敌人时 \n"..CNumb("{toughness:%s}", "tghns_var_rgb").." 连携"..CKWord("", "Toughness_rgb_zh_cn").."回复，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 没有胆量，没有荣耀
		},
		--[+ BASH +]--
		-- Crit Chance (per tier)
		...
		["loc_trait_bespoke_crit_chance_on_push_desc"] = { -- crit_chance: +15%,  time: 3, s->seconds, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes en poussant les ennemies.",
			-- ["zh-tw"] = "推開敵人時 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Crit_chance", "Crit_chance_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 猛撞
				-- 砍刀 -- 7.5% | 10% | 12.5% | 15%
			-- ["zh-cn"] = "推搡敌人时 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." 近战"..CKWord("", "Crit_chance_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 猛击
		},
		--[+ TENDERISER +]--
		-- Power (per tier)
		...
		["loc_trait_bespoke_increased_power_on_weapon_special_follow_up_hits_desc"] = { -- power: +15%, +colors
			...
			-- fr = CNumb("{power:%s}", "pwr_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pour vos "..CNumb("3", "n_3_rgb").." prochaines attaques de mélée lors d'une attaque spéciale d'arme réussie."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "特殊攻擊命中敵人時，接下來 "..CNumb("3", "n_3_rgb").." 次的近戰攻擊，\n獲得 "..CNumb("{power:%s}", "pwr_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 肉槌
				-- 砍刀 -- 10% | 15% | 20% | 25%
			-- ["zh-cn"] = "特殊攻击命中敌人时，\n下 "..CNumb("3", "n_3_rgb").." 次近战攻击 "..CNumb("{power:%s}", "pwr_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。"..CNote("Pwr_note_rgb_zh_cn"), -- 大肉锤
		},
		...
		["loc_trait_bespoke_pass_past_armor_and_damage_on_heavy_attack_desc"] = { -- damage: 10%, +colors
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." pour les attaques puissantes pleinement chargées, elles ignorent également le "..CKWord("", "Hit_mass_rgb_fr").." des ennemies.",
			-- ["zh-tw"] = "完全蓄力的重攻擊 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Damage", "Damage_rgb_tw").."，\n並無視敵人的 "..CKWord("Hit_mass", "Hit_mass_rgb_tw").."。", -- 勢不可擋
				-- 砍刀 -- 2.5% | 5% | 7.5% | 10%
			-- ["zh-cn"] = "完全蓄力的重攻击 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("伤害", "Damage_rgb_zh_cn").." 同时无视装甲赋予的"..CKWord("", "Hit_mass_rgb_zh_cn").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 势不可挡
		},
		--[+ TORMENT +]--
		-- Melee Power (per tier)
		...
		["loc_trait_bespoke_increase_power_on_weapon_special_hit_desc"] = { -- power_level: +24%,  time: 3.5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une attaque spéciale d'arme réussie."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "特殊攻擊命中敵人時 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 凌遲
				-- 十字鎬 -- 12% | 16% | 20% | 24%
			-- ["zh-cn"] = "特殊攻击命中敌人时 \n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 折磨
		},
		--[+ SLOW AND STEADY +]--
		...
		["loc_trait_bespoke_toughness_on_hit_based_on_charge_time_desc"] = { -- toughness: 8%, +colors
			...
			-- fr = "Récupérez "..CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr").." lorsque vous touchez un ennemie avec une attaque puissante, dépend du temps de charge.",
			-- ["zh-tw"] = "重擊攻擊命中敵人時 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("Toughness", "Toughness_rgb_tw").."，\n回復量依據蓄力時間恢復。", -- 緩慢而確實
				-- 十字鎬 -- 5% | 6% | 7% | 8% (up to 24%)
			-- ["zh-cn"] = "随重攻击蓄力时间增加叠加层数，\n命中敌人时，每层使"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。\n最多叠加 "..CNumb("3", "n_3_rgb").." 层。", -- 步稳行远
		},
		...
		["loc_trait_block_break_pushes_new_desc"] = { -- block_cost: -30%, cooldown: 15, +colors
			...
			-- fr = CNumb("{block_cost:%s}", "block_var_rgb").." de réduction du coût de blocage. Quand l'"..CKWord("", "Stamina_rgb_fr").." de l'Ogryn atteint "..CNumb("0", "n_0_rgb").." en bloquant des attaques, il repousse les ennemies dans un rayon de "..CNumb("5", "n_5_rgb").." mètres. Temps de recharge : "..CNumb("{cooldown:%s}", "cd_var_rgb").." secondes.",
			...
			-- ["zh-cn"] = CNumb("{block_cost:%s}", "block_var_rgb").." 格挡消耗。格挡期间"..CKWord("", "Stamina_rgb_zh_cn").."耗尽时，\n推开 "..CNumb("5", "n_5_rgb").." 米内的敌人，冷却时间 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。", -- 最后的卫士
		},
		--[+ OFFENSIVE DEFENCE +]--
		-- Melee Power per stack (per tier)
		...
		["loc_trait_damage_bonus_on_block_desc"] = { -- power: +10%, duration: 3.5, stacks: 5, +colors -- ..CNote("Pwr_note_rgb
			...
			-- fr = "Pour chaque point d'"..CKWord("", "Stamina_rgb_fr").." dépensé pour bloquer. Votre prochaine attaque de mélée gagne "..CNumb("{power:%s}", "pwr_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." par cumule et consomme un cumule. Dure "..CNumb("{duration:%s}", "dur_var_rgb").." secondes. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "格挡期间，每消耗 "..CNumb("1", "n_1_rgb").." "..CKWord("", "Stamina_rgb_zh_cn").." "..CNumb("{power:%s}", "pwr_var_rgb").." 近战"..CKWord("", "Strength_rgb_zh_cn").."，\n持续 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 以守为攻
		},
		...
		["loc_trait_bespoke_armor_rending_bayonette_crowbar_desc"] = { -- rending: 2.5%, stacks: 4, time: 5, max_stacks: 16, s->seconds, +colors
			...
			-- ["zh-tw"] = "特殊攻擊命中敵人時，\n使其獲得 "..CKWord("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Brittleness", "Brittleness_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒， "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層時為 "..CNumb("40%", "pc_40_rgb").." 。" .. CKWord("Brtl_note", "Brtl_note_rgb_tw"), -- 開罐器
				-- 撕裂槍 -- 10 | 12 | 14 | 16
			-- ["zh-cn"] = "特殊攻击命中时，对目标施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Brittleness_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层，最高 "..CNumb("40%", "pc_40_rgb").."。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 开罐器
		},
	...
	--[+ RANGED - ДАЛЬНИЙ БОЙ - 远程武器 +]--
		...
		["loc_trait_bespoke_followup_shots_ranged_weakspot_damage_desc"] = { -- damage: +50%, +colors
			...
			-- fr = CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("", "Weakspot_dmg_rgb_fr").." lors des "..CNumb("2e", "n_2e_rgb")..", "..CNumb("3e", "n_3e_rgb")..", "..CNumb("4e", "n_4e_rgb").." tirs d'une salve.",
			-- ["zh-tw"] = "齊射的第二、三與第四發射擊，\n獲得 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Weakspot_dmg", "Weakspot_dmg_rgb_tw").."。", -- 懲罰齊射
				-- 步兵自動槍, 偵查雷射槍 -- 35% | 40% | 45% | 50%
			-- ["zh-cn"] = "齐射的第二、第三和第四发射击\n"..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("", "Weakspot_dmg_rgb_zh_cn").."。", -- 惩戒齐射
		},
		--[+ FIRE FRENZY +]--
		-- Close Damage per stack (per tier)
		...
		["loc_trait_bespoke_increase_power_on_close_kill_desc"] = { -- power_level: 6.5%, time: 3.5, stacks: 5, +colors, +note
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une élimination à moins de "..CNumb("12.5", "n_12_5_rgb").." mètres. Se cumule jusqu'à "..CNumb("5", "n_5_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "击杀 "..CNumb("12.5", "n_12_5_rgb").." 米内的敌人时 \n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("5", "n_5_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 死亡喷吐
		},
		...
		["loc_trait_bespoke_increased_sprint_speed_desc"] = { -- stamina: 50%, +colors
			...
			-- fr = "Gagnez une immunité contre les attaques à distance lorsque vous courez avec plus de "..CNumb("{stamina:%s}", "stam_var_rgb").." d'"..CKWord("", "Stamina_rgb_fr")..".",
			-- ["zh-tw"] = "當衝刺時 "..CKWord("Stamina_c_r", "Stamina_c_r_rgb_tw").." 超過 "..CNumb("{stamina:%s}", "stam_var_rgb").." 時，\n將獲得對遠程攻擊的免疫效果。", -- 輕裝
			-- 槍托自動槍, 步兵自動槍, 偵查雷射槍 -- 80% | 70% | 60% | 50%
			-- ["zh-cn"] = "以超过 "..CNumb("{stamina:%s}", "stam_var_rgb").." "..CKWord("", "Stamina_rgb_zh_cn").."疾跑时，\n闪避全部远程攻击。", -- 简装
		},
		...
		["loc_trait_bespoke_toughness_on_continuous_fire_desc"] = { -- toughness: +4%, ammo: 10%, stacks: 5, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr").." pour chaque "..CNumb("{ammo:%s}", "ammo_var_rgb").." du chargeur utilisé en tir continu. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = "连续射击期间，\n每消耗弹匣容量 "..CNumb("{ammo:%s}", "ammo_var_rgb").." 的弹药，回复"..CKWord("", "Toughness_rgb_zh_cn")..",\n每叠加 "..CNumb("1", "n_1_rgb").." 层，"..CKWord("", "Toughness_rgb_zh_cn").."回复效果 "..CNumb("{toughness:%s}", "tghns_var_rgb").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。", -- 鼓舞弹幕
		},
		--[+ GHOST +]--	08.12.2025
		-- Duration (per tier)
		...
		["loc_trait_bespoke_count_as_dodge_vs_ranged_on_weakspot_desc"] = { -- time: 1.2, +colors
			...
			-- fr = "Immunité contre les attaques à distance pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un "..CKWord("", "Weakspothit_rgb_fr")..".",
		...
		["loc_trait_bespoke_crit_chance_based_on_aim_time_desc"] = { -- crit_chance: +10%, time: 0.2, stacks: 10, +colors, second->seconds
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_fr").." chaque fois de vous passez "..CNumb("{time:%s}", "time_var_rgb").." secondes à viser. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois. Tous les cumuls sont déchargés lorsque vous tirez.",
			...
			-- ["zh-cn"] = "瞄准期间，每 "..CNumb("{time:%s}", "time_var_rgb").." 秒 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层，射击后清空所有层数。", -- 外科手术
		},
		...
		["loc_trait_bespoke_crit_chance_based_on_ammo_left_desc"] = { -- crit_chance: +0.6%, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_fr").." pour chaque munition utilisée dans votre arme. Se réinitialise lorsque vous rechargez.",
			-- ["zh-tw"] = "每消耗一發彈藥 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Crit_chance", "Crit_chance_rgb_tw").."。\n在重新裝填時重置效果。", -- 克魯錫安輪盤
				-- 快拔左輪手槍 -- 4.5% | 5% | 5.5% | 6%
			-- ["zh-cn"] = "弹匣每缺失一枚弹药 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。", -- 轮盘赌
		},
		--[+ DEADLY ACCURATE +]--
		...
		["loc_trait_bespoke_crit_weakspot_finesse_desc"] = { -- crit_weakspot_damage: +100%, +colors
			...
			-- fr = CNumb("{crit_weakspot_damage:%s}", "critwkspdmg_var_rgb").." de "..CKWord("", "Crit_dmg_r_rgb_fr").." sur un "..CKWord("", "Weakspothit_rgb_fr")..".",
			...
			-- ["zh-cn"] = CNumb("{crit_weakspot_damage:%s}", "critwkspdmg_var_rgb").." "..CKWord("", "Crit_rgb_zh_cn")..""..CKWord("", "Weakspot_dmg_rgb_zh_cn").."。", -- 致命精准
		},
		--[+ NO RESPITE +]--
		...
		["loc_trait_bespoke_stagger_count_bonus_damage_desc"] = { -- damage: +20%, +colors
			...
			-- fr = "Jusqu'à "..CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." lors d'un coup sur un ennemi qui "..CKWord("", "Staggered_rgb_fr")..". Le plus l'ennemie "..CKWord("", "Staggered_rgb_fr").." le plus il reçoit de "..CKWord("Dégâts", "Damage_rgb_fr")..".",
		...
		["loc_trait_bespoke_power_bonus_on_first_shot_desc"] = { -- power_level: +20%, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." lors du premier tir d'une salve."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "齐射的第一发射击 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。"..CNote("Pwr_note_rgb_zh_cn"), -- 开场白
		},
		--[+ HEADHUNTER +]--
		-- Crit Chance per stack (per tier)
		...
		["loc_trait_bespoke_weakspot_stacking_crit_chance_desc"] = { -- crit_chance: +20%, stacks: 5, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_fr").." sur un "..CKWord("", "Weakspothit_rgb_fr").." jusqu'à votre prochain "..CKWord("", "Crit_hit_rgb_fr")..". Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothit_rgb_zh_cn").."时 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层，\n"..CKWord("", "Crit_hit_rgb_zh_cn").."后清空所有叠加层数。", -- 猎颅者
		},
		...
		["loc_trait_bespoke_suppression_negation_on_weakspot_desc"] = { -- time: 3.6, s->seconds, +colors
			...
			-- fr = "Gagnez une immunité à la suppression pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un "..CKWord("", "Weakspothit_rgb_fr")..".",
		...
		["loc_trait_bespoke_power_bonus_on_continuous_fire_desc"] = { -- power_level: +8%, ammo: 10%, stacks: 5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pour chaque "..CNumb("{ammo:%s}", "ammo_var_rgb").."  du chargeur utilisé en tir continu. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "连续射击期间，\n每消耗弹匣容量 "..CNumb("{ammo:%s}", "ammo_var_rgb").." 的弹药，\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 连续射击
		},
		...
		["loc_trait_bespoke_stacking_crit_bonus_on_continuous_fire_desc"] = { -- crit_chance: +20%, ammo: 10%, stacks: 5, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pour chaque "..CNumb("{ammo:%s}", "ammo_var_rgb").."  du chargeur utilisé en tir continu. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = "连续射击期间，\n每消耗弹匣容量 "..CNumb("{ammo:%s}", "ammo_var_rgb").."的弹药，\n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。", -- 列队行进
		},
		...
		["loc_trait_bespoke_stacking_power_bonus_on_staggering_enemies_desc"] = { -- power_level: +8%, stacks: 5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pour chaque ennemie que vous faites "..CKWord("", "Staggering_rgb_fr")..". Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Stagger_rgb_zh_cn").."敌人时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 火力压制
		},
		...
		["loc_trait_bespoke_bleed_on_ranged_desc"] = { -- stacks: 4, +colors
			...
			-- fr = CKWord("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." Cumuls de "..CKWord("", "Bleed_rgb_fr").." aux ennemis sur les coups à distance.",
			-- ["zh-tw"] = "遠程攻擊命中敵人時，使其獲得 "..CKWord("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("Bleed", "Bleed_rgb_tw").."。\n上限 "..CNumb("16", "n_16_rgb").." 層。", -- 出血穿透
				-- 矛頭爆矢槍, 爆彈手槍  -- 1 | 2 | 3 | 4
			-- ["zh-cn"] = "远程攻击命中时 "..CKWord("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CKWord("", "Bleed_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层。", -- 刺穿
		},
		--[+ LETHAL PROXIMITY +]--
		-- Explosion Radius Increase (per tier)
		...
		["loc_trait_bespoke_crit_chance_bonus_on_melee_kills_desc"] = { -- crit_chance: +20%, time: 3.5, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." à distance après une élimination avec une arme de mélée pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes.",
			...
			-- ["zh-cn"] = "近战击杀时 \n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." 远程"..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 近身射击
		},
		--[+ EXECUTION +]--
		...
		["loc_trait_bespoke_damage_vs_stagger_desc"] = { -- vs_stagger: 20%, +colors
			...
			-- fr = CNumb("{vs_stagger:%s}", "dmgvsstgr_var_rgb").." de "..CKWord("Dégâts", "Damage_rgb_fr").." Bonus contre les ennemis qui "..CKWord("", "Staggered_rgb_fr")..".",
			-- ["zh-tw"] = "攻擊 "..CKWord("Staggered", "Staggered_rgb_tw").." 敵人 "..CNumb("{vs_stagger:%s}", "dmgvsstgr_var_rgb").." "..CKWord("Damage", "Damage_rgb_tw").."。", -- 處決
				-- 爆彈手槍 -- 5% |10% | 15% | 20%
			-- ["zh-cn"] = "对"..CKWord("", "Staggered_rgb_zh_cn").."敌人 "..CNumb("{vs_stagger:%s}", "dmgvsstgr_var_rgb").." "..CKWord("伤害", "Damage_rgb_zh_cn").."。", -- 处决
		},
		...
		["loc_trait_bespoke_toughness_on_elite_kills_desc"] = { -- toughness: +30%, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr").." lors d'une élimination d'élite.",
			-- ["zh-tw"] = "擊殺精英敵人 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("Toughness", "Toughness_rgb_tw").."。",-- 榮耀獵手
				-- 矛頭爆矢槍 -- 10% | 12% | 14% | 16%
				-- 電漿槍 -- 17.5% | 20% | 22.5% | 25%
				-- 爆彈手槍, 快拔左輪手槍 -- 18% | 22% | 26% | 30%
				-- 擲彈兵臂鎧 -- 20% | 25% | 30% | 35%
			-- ["zh-cn"] = "击杀精英敌人时"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。", -- 荣耀猎人
		},
		--[+ SURGE +]--
		...
		["loc_trait_bespoke_double_shot_on_primary_crit_and_crit_chance_desc"] = { -- crit_chance: +5%, value: 2, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." à distance.\n"..CNumb("{value:%s}", "value_var_rgb").." tirs lors d'un "..CKWord("", "Crit_hit_rgb_fr").." de l'attaque principale (fonctionne sur l'attaque secondaire du Bâton de force \"Assaut du vide\").",
			...
			-- ["zh-cn"] = CNumb("{crit_chance:%s}", "crit_var_rgb").." 远程"..CKWord("", "Crit_chance_rgb_zh_cn").."。\n主要攻击"..CKWord("", "Crit_hit_rgb_zh_cn").."时，发射 "..CNumb("{value:%s}", "value_var_rgb").." 枚射弹。", -- 激涌
		},
		--[+ SURGE +]-- DOUBLE!
		-- Ranged Crit Chance (per tier)
		-- Electrokinetic Staff, Voidblast Staff, Voidstrike Staff -- 2% | 3% | 4% | 5%
		...
		["loc_trait_bespoke_increased_crit_chance_scaled_on_peril_desc"] = { -- crit_chance: 5%, crit_chance_max: 20%, +colors
			en = CKWord("+", "n_plus_rgb")..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Critical Chance", "Crit_chance_rgb").." per "..CNumb("20%", "pc_20_rgb").." "..CKWord("Peril", "Peril_rgb")..".\n"
				..Dot_nc.." Stacks up to "..CNumb("4", "n_4_rgb").." times. Maximum of "..CKWord("+", "n_plus_rgb")..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").." "..CKWord("Critical Chance", "Crit_chance_rgb").." at "..CNumb("80%", "pc_80_rgb").." "..CKWord("Peril", "Peril_rgb")..".",
			...
			-- fr = "Obtenez entre "..CNumb("{crit_chance:%s}", "crit_var_rgb").." et "..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." en fonction de votre niveau de "..CKWord("", "Peril_rgb_fr").." actuel.",
			...
			-- ["zh-cn"] = "随"..CKWord("", "Peril_rgb_zh_cn").."增长叠加层数，\n每增长 "..CNumb("20%", "pc_20_rgb").."，"..CKWord("+", "n_plus_rgb")..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。\n最多叠加 "..CNumb("4", "n_4_rgb").." 层，最高 "..CKWord("+", "n_plus_rgb")..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").."。", -- 亚空间枢纽
		},
		--[+ TRANSFER PERIL +]--
		-- Peril Amount Removed (per tier)
		...
		["loc_trait_bespoke_peril_vent_on_weakspot_hit_desc"] = { -- warp_charge: 10%, +colors
			...
			-- fr = CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." de votre "..CKWord("", "Peril_rgb_fr").." est dissipé lors d'un "..CKWord("", "Weakspothit_rgb_fr")..".",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothit_rgb_zh_cn").."时，平息 "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." "..CKWord("", "Peril_rgb_zh_cn").."。", -- 转移危机值
		},
		--[+ RENDING SHOCKWAVE +]--
		-- Brittleness Stacks (per tier)
		...
		["loc_trait_bespoke_rend_armor_on_aoe_charge_desc"] = { -- stacks: 8, rending: 2.5%, time: 5, max_stacks: 16, s->seconds, +colors
			...
			-- ["zh-tw"] = "根據次要攻擊的蓄力時間，\n使攻擊目標獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("+", "n_plus_rgb")..CNumb("{rending:%s}", "rending_var_rgb").." 的 "..CKWord("Brittleness", "Brittleness_rgb_tw").."，\n可持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒，上限 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層 "..CNumb("40%", "pc_40_rgb").."。" .. CKWord("Brtl_note", "Brtl_note_rgb_tw"), -- 撕扯震盪
				-- 虛空爆破力場法杖 -- 2 | 4 | 6 | 8
			-- ["zh-cn"] = "随次要攻击蓄力时间提升效果，\n最多对目标施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("", "Brittleness_rgb_zh_cn").."，\n持续"..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层，最高"..CNumb("40%", "pc_40_rgb").."。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 撕裂冲击波
		},
		--[+ FOCUSED CHANNELLING +]--
		...
		["loc_trait_bespoke_uninterruptable_while_charging_and_movement_desc"] = { -- reduction: 50%, +colors
			en = CKWord("-", "n_minus_rgb")..CNumb("{reduction:%s}", "red_var_rgb").." Movement Speed penalty during Secondary Attack. Your Secondary Attack cannot be interrupted. "
				..Dot_red.." Charging actions of all Staves are already uninterruptible by default.",
			ru = CKWord("-", "n_minus_rgb")..CNumb("{reduction:%s}", "red_var_rgb").." к штрафу скорости передвижения во время вторичной атаки. Ваша вторичная атака не может быть прервана. "
			...
			-- ["zh-tw"] = "次要攻擊的移動速度懲罰 "..CKWord("-", "n_minus_rgb")..CNumb("{reduction:%s}", "red_var_rgb").."，\n且無法被中斷。", -- 專注引導
				-- 電流力場法杖, 烈焰力場法杖, 虛空爆破力場法杖, 虛空打擊力場法杖 -- 20% | 30% | 40% | 50%
			-- ["zh-cn"] = "次要攻击蓄力期间 "..CKWord("-", "n_minus_rgb")..CNumb("{reduction:%s}", "red_var_rgb").." 移动速度惩罚，\n同时敌人的近战及远程攻击无法眩晕你。", -- 专注引导
		},
			-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! BUGGED !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		--[+ BLAZING SPIRIT +]--
		...
		["loc_trait_bespoke_warpfire_burn_on_crit_desc"] = { -- stacks: 4, +colors -- REMOVED: [Up to 6 Stacks.] because for some reason this description is used for the Psyker Greatsword, but it has 12 stacks max. Fatshark FFS!
			...
			-- fr = "L'ennemie gagne "..CKWord("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CKWord("", "Soulblaze_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr")..".", -- Jusqu'à 6 cumuls.
			-- ["zh-tw"] = "敵人於 "..CKWord("Crit_hit", "Crit_hit_rgb_tw").." 時會獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("Soulblaze", "Soulblaze_rgb_tw").."，上限 "..CNumb("6", "n_6_rgb").." 層。", -- 燃燒靈魂 -- 這個說明同時也被套用在烈焰力場巨劍，但是他最多12層。
				-- 虛空爆破力場法杖, 虛空打擊力場法杖 -- 1 | 2 | 3 | 4
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").."时, 对敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CKWord("", "Soulblaze_rgb_zh_cn").."。", -- 烈焰之魂 -- 描述存在BUG，炙焰力场巨剑错误使用该段描述，暂时移除字段：「"最多叠加 "..CNumb("6", "n_6_rgb").." 层。"」以确保描述不会出现错误。
		},
		--[+ PENETRATING FLAME +]--
		-- Brittleness Stacks (per tier)
		...
		["loc_trait_bespoke_armor_rending_from_dot_burning_desc"] = { -- num_stacks: 4, rending_percentage: 1%, duration: 5, max_stacks: 10, +colors
			...
			-- fr = "Les coups directs appliquent "..CNumb("1", "n_1_rgb").." cumul de "..CNumb("{num_stacks:%s}", "stacks_num_var_rgb")..CNumb("%", "pc_rgb").." "..CKWord("", "Brittleness_rgb_fr").." pendant "..CNumb("{duration:%s}", "dur_var_rgb").." secondes. Jusqu'à "..CNumb("20%", "pc_20_rgb").."."..CKWord("", "Brtl_note_rgb_fr"),
			...
			-- ["zh-cn"] = "命中时，对目标施加 "..CNumb("{num_stacks:%s}", "stacks_num_var_rgb").." 层 "..CNumb("1%", "pc_1_rgb").." "..CKWord("", "Brittleness_rgb_zh_cn").."，持续 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。\n最多叠加 "..CNumb("20", "n_20_rgb").." 层，最高 "..CNumb("20%", "pc_20_rgb").."。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 穿透火焰
		},
		--[+ SHOWSTOPPER +]--
		...
		["loc_trait_bespoke_burninating_on_crit_desc"] = { -- stacks: +4, max_stacks: 12, Stack(s)->Stacks, +colors
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CKWord("", "Burn_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr").." jusqu'à un maximum de "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." cumuls.",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").."时 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("", "Burn_rgb_zh_cn").."。最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层。", -- 地狱火
		},
		--[+ EFFICIENCY +]--
		-- Cooldown (per tier)
		-- Infantry Lasguns -- 5.5s | 5s | 4.5s | 4s
		["loc_trait_bespoke_first_shot_ammo_cost_reduction_desc"] = { -- ammo: 33%, time: 4, s->seconds, +colors
			en = CKWord("-", "n_minus_rgb")..CNumb("66%", "pc_66_rgb").." Ammo consumption per shot every "..CNumb("{time:%s}", "time_var_rgb").." seconds. "
			...
			ru = CKWord("-", "n_minus_rgb")..CNumb("66%", "pc_66_rgb").." от затрат боеприпасов на выстрел раз в "..CNumb("{time:%s}", "time_var_rgb").." секунды. "
			...
			-- ["zh-tw"] = "每過 "..CNumb("{time:%s}", "time_var_rgb").." 秒，\n首次射擊的彈藥消耗將減少 "..CNumb("{ammo:%s}", "ammo_var_rgb").." 。", -- 效率
				-- 步兵雷射槍 -- 5.5 | 5 | 4.5 | 4
			-- ["zh-cn"] = "下次射击 "..CKWord("-", "n_minus_rgb")..CNumb("{ammo:%s}", "ammo_var_rgb").." 弹药消耗，\n冷却时间 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 效益
		},
		...
		["loc_trait_bespoke_crit_chance_on_chained_weakspot_hits_desc"] = { -- crit_chance: +5%, +colors
			...
			-- fr = "Jusqu'à "..CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." lors d'un "..CKWord("", "Weakspothit_rgb_fr").." répété à distance (toute cible). Jusqu'à "..CNumb("5", "n_5_rgb").." cumuls.",
			...
			-- ["zh-cn"] = "连续"..CKWord("", "Weakspothit_rgb_zh_cn").."时 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." 远程"..CKWord("", "Crit_chance_rgb_zh_cn").."。\n最多叠加 "..CNumb("5", "n_5_rgb").." 层。", -- 集中火力
		},
		...
		["loc_trait_bespoke_crit_chance_on_successful_dodge_desc"] = { -- crit_chance: +12.5%, time: 6, +colors
			...
			-- ["zh-cn"] = "成功闪避时 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." 远程"..CKWord("", "Crit_chance_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 亡命之徒
		},
		...
		["loc_trait_bespoke_toughness_on_crit_kills_desc"] = { -- toughness: 16%, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr").." lors d'une élimination par "..CKWord("", "Crit_hit_rgb_fr")..".",
			-- ["zh-tw"] = CKWord("Crit_k", "Crit_k_rgb_tw").." 時 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("Toughness", "Toughness_rgb_tw").."。", -- 慰藉精準
				-- 擲彈兵臂鎧 -- 24% | 28% | 32% | 36%
				-- 重型雷射手槍 -- 10% | 12% | 14% | 16%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hits_k_rgb_zh_cn").."时，"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。", -- 激励精准
		},
		--[+ FLECHETTE +]--
		-- Bleed Stacks (per tier)
		...
		["loc_trait_bespoke_bleed_on_crit_ranged_desc"] = { -- stacks: 6, +colors
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CKWord("", "Bleed_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr")..". Jusqu'à "..CNumb("16", "n_16_rgb").." cumuls.",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_rgb_zh_cn").."时 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("", "Bleed_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层。", -- 箭弹
		},
		--[+ MAN-STOPPER +]--
		...
		["loc_trait_bespoke_cleave_on_crit_and_stagger_desc"] = { -- stagger: +25%, +colors
			...
			-- fr = "Augmente le "..CKWord("", "Cleave_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr").." augmente également de "..CNumb("{stagger:%s}", "stgr_var_rgb").." le "..CKWord("", "Stagger_rgb_fr")..".",
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_rgb_zh_cn").."时 "..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."，\n同时无视敌人的"..CKWord("", "Hit_mass_rgb_zh_cn").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 强力炮弹
		},
		--[+ SCATTERSHOT +]--
		...
		["loc_trait_bespoke_crit_chance_on_hitting_multiple_with_one_shot_desc"] = { -- crit_chance: +12%, stacks: 5, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pour chaque ennemie touché par votre attaque précédente . Se cumuls "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = "上次攻击每命中一名敌人\n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。", -- 散射
		},
		--[+ FULL BORE +]--
		-- Power (per tier)
		...
		["loc_trait_bespoke_power_bonus_on_hitting_single_enemy_with_all_desc"] = { -- power_level: +20%, time: 5, s->seconds, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lorsque chaque plomb d'un tir touche le même ennemie."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "單次射擊的所有子彈皆命中同一名敵人，\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 全孔射擊
				...
				-- 反衝者 -- 18% | 22% | 26% | 30%
			-- ["zh-cn"] = 一次射击的全部弹丸都命中同一敌人时\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 全孔射击
		},
		--[+ BOTH BARRELS +]--
		...
		["loc_trait_bespoke_power_bonus_on_chained_weakspot_hits_desc"] = { -- power_level: +6%, stacks: 5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." lors d'un "..CKWord("", "Weakspothit_rgb_fr").." en chaîne (toute cible). Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothit_rgb_zh_cn").."时 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，\n持续 "..CNumb("3.5", "n_3_5_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 特技射手
		},
		--[+ HAND-CANNON +]--
		-- Rending (per tier)
		...
		["loc_trait_bespoke_rending_on_crit_desc"] = { -- rend: +60%, +colors
			...
			-- fr = CNumb("{rend:%s}", "rend_var_rgb").." de "..CKWord("", "Rending_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr").."."..CNote("Rend_note_rgb_fr"),
			-- ["zh-tw"] = CKWord("Crit_hit", "Crit_hit_rgb_tw").." 時 "..CNumb("{rend:%s}", "rend_var_rgb").." "..CKWord("Rending", "Rending_rgb_tw").."。" .. COLORS_KWords_tw.CNote("Rend_note_rgb_tw"), -- 手銃
				-- 快拔左輪手槍 -- 30% | 40% | 50% | 60%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").." "..CNumb("{rend:%s}", "rend_var_rgb").." "..CKWord("", "Rending_rgb_zh_cn").."。"..CNote("Rend_note_rgb_zh_cn"), -- 手持火炮
		},
		--[+ SHATTERING IMPACT +]--
		-- Brittleness Stacks (per tier)
		...
		["loc_trait_bespoke_armor_rend_on_projectile_hit_desc"] = { -- stacks: 4, rending: 2.5%, time: 5, max_stacks: 16, s->seconds, +colors
			...
			-- ["zh-cn"] = "命中时，对目标施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{rending:%s}", "rending_var_rgb").." \n"..CKWord("", "Brittleness_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层，最高 "..CNumb("40%", "pc_40_rgb").."。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 破碎冲击
		},
		--[+ EVERLASTING FLAME +]--
		...
		["loc_trait_bespoke_ammo_spent_from_reserve_on_crit_desc"] = { -- +colors
			...
			-- fr = "Les "..CKWord("", "Crit_hits_rgb_fr").." dépensent des munitions de votre réserve à la place de votre réservoir de carburant actuel.",
		...
		["loc_trait_bespoke_ignore_stagger_reduction_with_primary_on_burning_desc"] = { -- stagger_reduction: 60%, impact_modifier: +45%, +colors
			...
			-- fr = "Votre attaque principale ignore "..CNumb("{stagger_reduction:%s}", "stgrrdct_var_rgb").." de le résistance "..CKWord("", "Stagger_rgb_fr").." des ennemis qui "..CKWord("", "Burning_rgb_fr")..", et inflige "..CNumb("{impact_modifier:%s}", "impmod_var_rgb").." d'"..CKWord("", "Impact_rgb_fr")..".",
			...
			-- ["zh-cn"] = "主要攻击无视"..CKWord("", "Burning_rgb_zh_cn").."敌人 "..CNumb("{stagger_reduction:%s}", "stgrrdct_var_rgb").." "..CKWord("", "Stagger2_rgb_zh_cn").."抗性，同时 "..CNumb("{impact_modifier:%s}", "impmod_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."。", -- 火上浇油
		},
		--[+ OVERPRESSURE +]--
		-- Power per stack (per tier)
		...
		["loc_trait_bespoke_power_scales_with_clip_percentage_desc"] = { -- power_level: +5%, stacks: 5, +colors
			...
			-- fr = "Jusqu'à "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr")..", en fonction des munitions restantes. Se cumules "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "随弹匣剩余弹药叠加层数，\n每消耗弹匣容量 "..CNumb("20%", "pc_20_rgb").." 的弹药\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 超压
		},
		--[+ HOT-SHOT +]--	08.12.2025
		-- Enemy Hit Mass Reduction (per tier)
		...
		["loc_trait_bespoke_cleave_on_weakspot_hits_desc"] = { -- hit_mass_reduction: +50%, +colors
			...
			-- fr = "Les "..CKWord("", "Weakspothits_rgb_fr").." gagnent "..CNumb("{hit_mass_reduction:%s}", "hit_mass_red_var_rgb").." de "..CKWord("", "Cleave_rgb_fr")..".",
			-- ["zh-tw"] = CKWord("Weakspothits", "Weakspothits_rgb_tw").." "..CKWord("+", "n_plus_rgb")..CNumb("{hit_mass_reduction:%s}", "hit_mass_red_var_rgb").." "..CKWord("Cleave", "Cleave_rgb_tw").."。", -- 激射
				-- 冥潮雷射槍 -- 80% | 70% | 60% | 50%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Weakspothits_rgb_zh_cn").."使目标"..CKWord("", "Hit_masss_rgb_zh_cn").."降至 "..CNumb("{hit_mass_reduction:%s}", "hit_mass_red_var_rgb").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 炙热射击
		},
		--[+ WEIGHT OF FIRE +]--
		-- Charge Time Reduction per stack (per tier)
		...
		["loc_trait_bespoke_rend_armor_on_charged_shots_desc"] = { -- min_stack_count: 8, max_stack_count: 12, +colors
			...
			-- fr = "Inflige de "..CNumb("{min_stack_count:%s}", "min_stk_cnt_var_rgb").." à "..CNumb("{max_stack_count:%s}", "max_stk_cnt_var_rgb").." cumuls de "..CNumb("2.5%", "pc_2_5_rgb").." de "..CKWord("", "Brittleness_rgb_fr").." aux ennemis touchés, en fonction du niveau de charge."..CKWord("", "Brtl_note_rgb_fr"),
			...
			-- ["zh-cn"] = "随充能时间提升效果，对目标施加\n"..CNumb("{min_stack_count:%s}", "min_stk_cnt_var_rgb").." 到 "..CNumb("{max_stack_count:%s}", "max_stk_cnt_var_rgb").." 层 "..CNumb("2.5%", "pc_2_5_rgb").." "..CKWord("", "Brittleness_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层，最高 "..CNumb("40%", "pc_40_rgb").."。"..CKWord("", "Brtl_note_rgb_zh_cn"), -- 装甲之祸
		},
		--[+ POWER BLAST +]--
		-- Crit Chance per stack (per tier)
		...
		["loc_trait_bespoke_increased_crit_chance_bonus_based_on_charge_time_desc"] = { -- crit_chance_min: 5%, crit_chance_max: 25%, +colors
			en = CKWord("+", "n_plus_rgb")..CNumb("{crit_chance_min:%s}", "critchmin_var_rgb").." "..CKWord("Critical Chance", "Crit_chance_rgb").." per "..CNumb("20%", "pc_20_rgb").." charge level. "..Dot_nc.." Stacks up to "..CNumb("5", "n_5_rgb").." times. Maximum of "..CKWord("+", "n_plus_rgb")..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").." "..CKWord("Critical Chance", "Crit_chance_rgb").." at "..CNumb("91%", "pc_91p_rgb").." charge level.\n"
			...
			-- fr = "Gagnez entre "..CNumb("{crit_chance_min:%s}", "critchmin_var_rgb").." et "..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").." de "..CKWord("", "Crt_chance_rgb_fr").." en fonction du niveau de charge lorsque vous tirez.",
			...
			-- ["zh-cn"] = "随充能程度叠加层数，每充能\n"..CNumb("20%", "pc_20_rgb").." 叠加 "..CNumb("1", "n_1_rgb").." 层，每层 "..CKWord("+", "n_plus_rgb")..CNumb("{crit_chance_min:%s}", "critchmin_var_rgb").." "..CKWord("", "Crt_chance_rgb_zh_cn").."。\n最多叠加 "..CNumb("5", "n_5_rgb").." 层，最高 "..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").."。", -- 充能爆破
		},
		--[+ GETS HOT! +]--
		...
		["loc_trait_bespoke_crit_chance_scaled_on_heat_desc"] = { -- crit_chance: 50%, ranged_crit_damage: 10%, +colors
			...
			-- fr = "Augmente de "..CNumb("{crit_chance:%s}", "crit_var_rgb").." par cumul le "..CKWord("", "Crit_hit_chance_rgb_fr").."  proportionnellement à votre niveau de "..CKWord("", "Heat_rgb_fr").." actuel. Augmente également les "..CKWord("", "Crit_hit_color_rgb_fr").." à distance de "..CNumb("{ranged_crit_damage:%s}", "rangcrtdmg_var_rgb").." par cumul.",
			...
			-- ["zh-cn"] = "随"..CKWord("", "Heat_rgb_zh_cn").."增长叠加层数，\n每层 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crt_chance_rgb_zh_cn").."，\n同时 "..CNumb("{ranged_crit_damage:%s}", "rangcrtdmg_var_rgb").." 远程"..CKWord("", "Crit_dmg_r_rgb_zh_cn").."。\n最多叠加 "..CNumb("5", "n_5_rgb").." 层。", -- 升温！
		},
		--[+ VOLATILE +]--
		-- Charge Time Reduction per stack (per tier)
		...
		["loc_trait_bespoke_power_bonus_on_continuous_fire_alternative_desc"] = { -- power_level: +8%, stacks: 5, +colors
			...
			ru = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." к "..CKWord("силе", "sile_rgb_ru").." за каждый выстрел, сделанный во время непрерывной стрельбы. Суммируется "..CNumb("{stacks:%s}", "stacks_var_rgb").." раз. "
				..CNote("Pwr_note"), -- Стрельба без устали -- руоф Энтузиазм
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pour chaque tir effectué en tir continu. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "连续射击期间，每次射击 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 连续射击
		},
		--[+ RISING HEAT +]--
		-- Power per stack (per tier)
		...
		["loc_trait_bespoke_power_bonus_scaled_on_heat_desc"] = { -- power_level: +8%, stacks: 5, +colors
			...
			-- fr = "Jusqu'à "..CNumb("{damage:%s}", "dmg_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." en fonction du niveau de "..CKWord("", "Heat_rgb_fr").."."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "随"..CKWord("", "Heat_rgb_zh_cn").."增长提升效果\n，最高 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。"..CNote("Pwr_note_rgb_zh_cn"), -- 急剧升温
		},
		--[+ OPTIMISED COOLING +]--
		...
		["loc_trait_bespoke_reduced_heat_on_continuous_desc"] = { -- +colors
			en = CKWord("-", "n_minus_rgb")..CNumb("10%", "pc_10_rgb").." "..CKWord("Heat", "Heat_rgb").." generation per Stack for consecutive shots or charged shots.\n"
			...
			-- fr = "Vitesse de chargement augmentée inversement proportionnelle au niveau de "..CKWord("", "Heat_rgb_fr")..".",
			-- ["zh-tw"] = "連續精準射擊時，\n降低 "..CKWord("Heat", "Heat_rgb_tw").." 提升速度。上限 "..CNumb("5", "n_5_rgb").." 層。", -- 優化冷卻
				-- 電漿槍 -- 4% | 6% | 8% | 10% (up to ~41%)
			-- ["zh-cn"] = "连续射击期间，每次射击减少"..CKWord("", "Heat_rgb_zh_cn").."积累。最多叠加 "..CNumb("5", "n_5_rgb").." 层。", -- 优化冷却
		},
		--[+ FOCUSED COOLING +]--
		...
		["loc_trait_bespoke_reduced_overheat_on_crits_desc"] = { -- +colors
			...
			-- fr = CNumb("{heat_percentage:%s}", "heat_pc_var_rgb").." de génération de "..CKWord("", "Heat_rgb_fr").." lors d'un "..CKWord("", "Crit_hit_rgb_fr")..".",
			-- ["zh-tw"] = CKWord("Crit", "Crit_rgb_tw").." 時，產生的 "..CKWord("Heat", "Heat_rgb_tw").." 僅 "..CNumb("{heat_percentage:%s}", "heat_pc_var_rgb").."。", -- 專注冷卻
				-- 電漿槍 -- 30% | 40% | 50% | 60%
			-- ["zh-cn"] = COLORS_KWords_zh_cn.Crit_hit_rgb_zh_cn").."时，减少 "..CNumb("{heat_percentage:%s}", "heat_pc_var_rgb").." "..CKWord("", "Heat_rgb_zh_cn").."积累。", -- 专注冷却
		},
		--[+ GAUNTLET MOMENTUM +]--
		-- Melee Power per stack (per tier)
		...
		["loc_trait_bespoke_power_bonus_on_chained_melee_desc"] = { -- power: 5%, stacks: 10, time: 1.5, +colors
			...
			-- fr = CKWord("+", "n_plus_rgb")..CNumb("1", "n_1_rgb").." cumul de "..CNumb("{power:%s}", "pwr_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." de mélée, est ajouté pour chaque attaque de mélée avec le Gantelet. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois. Les cumuls dure "..CNumb("{time:%s}", "time_var_rgb").." secondes. {#color(255, 35, 5)}(bug:5% tout les niveaux de la bénédiction){#reset()}"..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "臂铠近战攻击命中敌人时\n"..CNumb("{power:%s}", "pwr_var_rgb").." 臂铠近战"..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。{#color(255, 35, 5)}\n（BUG：无论祝福级别如何，\n数值始终为 +5% 强度。）{#reset()}"..CNote("Pwr_note_rgb_zh_cn"), -- 挑战势头
		},
		--[+ PULVERISE +]--
		-- Crit Chance (per tier)
		...
		["loc_trait_bespoke_crit_chance_on_melee_kill_desc"] = { -- crit_chance: +25%, time: 3, +colors
			...
			-- fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'un élimination en mélée.",
			-- ["zh-tw"] = "近戰擊殺時 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("Crit_chance", "Crit_chance_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 粉碎
				-- 擲彈兵臂鎧 -- 10% | 15% | 20% | 25%
			-- ["zh-cn"] = "臂铠近战攻击击杀敌人时\n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。", -- 粉碎
		},
		--[+ DISRUPTIVE +]--
		-- Melee Power (per tier)
		...
		["loc_trait_bespoke_melee_power_bonus_after_explosion_desc"] = { -- power_level: 30%, time: 3.5, +colors
			...
			-- fr = "Toucher au moins "..CNumb("3", "n_3_rgb").." ennemies avec votre attaque secondaire vous octroie "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pour vos attaque de mélée pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "當次要攻擊命中至少 "..CNumb("3", "n_3_rgb").." 名敵人時，\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength_m", "Strength_m_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 顛覆性力量
				-- 擲彈兵臂鎧 -- 15% | 20% | 25% | 30%
			-- ["zh-cn"] = "次要攻击命中至少 "..CNumb("3", "n_3_rgb").." 名敌人时，\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近战"..CKWord("", "Strength_rgb_zh_cn").."，持续"..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 破坏者
		},
		--[+ EXPLOSIVE OFFENSIVE +]--
		-- Power (per tier)
		...
		["loc_trait_bespoke_power_bonus_after_weapon_special_multiple_desc"] = { -- power_level: 15%, time: 5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." bonus pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes après avoir touché plusieurs ennemies avec l'explosion spéciale de votre arme."..CNote("Pwr_note"),
			-- ["zh-tw"] = "特殊攻擊的爆炸命中多名敵人時，\n "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 爆炸使我強大
				-- 擲彈兵臂鎧 -- 6% | 9% | 12% | 15%
			-- ["zh-cn"] = "特殊攻击爆炸命中至少 "..CNumb("3", "n_3_rgb").." 名敌人时，\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。持续"..CNumb("{time:%s}", "time_var_rgb").."秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 爆炸攻势
		},
		--[+ PINPOINTING TARGET +]--
		-- Power per stack (per tier)
		...
		["loc_trait_bespoke_power_bonus_based_on_charge_time_ranged_desc"] = { -- power_level: +8%, time: 0.4, stacks: 5, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." toutes les "..CNumb("{time:%s}", "time_var_rgb").." secondes pendant la visée. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois. Tous les cumuls sont déchargés lorsque vous tirez."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "瞄准期间，每 "..CNumb("{time:%s}", "time_var_rgb").." 秒 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层，射击后清空所有层数。"..CNote("Pwr_note_rgb_zh_cn"), -- 精确定位
		},
		--[+ CHARMED RELOAD +]--
		...
		["loc_trait_bespoke_ammo_refill_from_reserve_on_crit_desc"] = { -- bullet_amount: +5, +colors
			...
			-- fr = CKWord("+", "n_plus_rgb")..CNumb("{bullet_amount:%s}", "blltam_var_rgb").." Munitions chargées depuis la réserve lors d'un "..CKWord("", "Crit_hit_rgb_fr")..".",
		...
		["loc_trait_bespoke_power_bonus_on_chained_hits_on_single_target_desc"] = { -- power: +10%, hit: 4, time: 2, stacks: 5, s->seconds, +colors
			...
			-- fr = CNumb("{power:%s}", "pwr_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." pour toutes les "..CNumb("{hit:%s}", "hit_var_rgb").." attaques sur une cible unique. Dure "..CNumb("{time:%s}", "time_var_rgb").." secondes и se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois."..CNote("Pwr_note_rgb_fr"),
			...
			-- ["zh-cn"] = "每命中同一敌人 "..CNumb("{hit:%s}", "hit_var_rgb").." 次 "..CNumb("{power:%s}", "pwr_var_rgb").." "..CKWord("", "Strength_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note_rgb_zh_cn"), -- 狂猛火力
		},
		--[+ CAN OPENER +]--
		-- Brittleness Stacks (per tier)
		...
		["loc_trait_bespoke_toughness_on_close_range_kills_desc"] = { -- toughness: +6%, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr").." lors d'une élimination à moins de "..CNumb("12.5", "n_12_5_rgb").." mètres.",
			-- ["zh-tw"] = CNumb("12.5", "n_12_5_rgb").." 公尺內擊殺敵人 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("Toughness", "Toughness_rgb_tw").."。", -- 浴血而生
				-- 撕裂槍 -- 4.5% | 5% | 5.5% | 6%
			-- ["zh-cn"] = "击杀 "..CNumb("12.5", "n_12_5_rgb").." 米内的敌人时，"..CKWord("", "Toughness_rgb_zh_cn").." "..CNumb("{toughness:%s}", "tghns_var_rgb").."。", -- 浴血而生
		},
		--[+ PIERCE +]--
		...
		["loc_trait_bespoke_pass_trough_armor_on_weapon_special_and_stagger_desc"] = { -- stagger: +25%, +colors
			...
			-- fr = "L'attaque spéciale gagne "..CNumb("{stagger:%s}", "stgr_var_rgb").." de "..CKWord("", "Stagger_rgb_fr").." и ignore le "..CKWord("", "Hit_mass_rgb_fr").." de l'armure.",
			-- ["zh-tw"] = "武器特殊攻擊可無視敵方護甲 "..CKWord("Hit_mass", "Hit_mass_rgb_tw").."，\n並附加 "..CNumb("{stagger:%s}", "stgr_var_rgb").." 的 "..CKWord("Stagger2", "Stagger2_rgb_tw").." 。", -- 穿透
				-- 反衝者, 震盪槍 -- 10% | 15% | 20% | 25%
			-- ["zh-cn"] = "特殊攻击 "..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("", "Impact_rgb_zh_cn").."，\n同时无视装甲赋予的"..CKWord("", "Hit_mass_rgb_zh_cn").."。"..CKWord("", "Hit_Mass_note_rgb_zh_cn"), -- 穿透
		},
		--[+ PUNISHING FIRE +]--
		-- Ranged Power (per tier)
		-- Kickback -- 6% | 9% | 12% | 15%
		["loc_trait_bespoke_shot_power_bonus_after_weapon_special_cleave_desc"] = { -- power_level: +15%, time: 3, +colors
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." sur vos attaques à distance pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes после avoir "..CKWord("", "Cleaving_rgb_fr").." plusieurs ennemies avec l'attaque spéciale de votre arme."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "特殊攻擊貫穿(順劈)多名敵人\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength_r", "Strength_r_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 懲罰射擊
				-- 反衝者 -- 6% | 9% | 12% | 15%
			-- ["zh-cn"] = "特殊攻击命中至少 "..CNumb("3", "n_3_rgb").." 名敌人时\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 远程"..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 惩罚之火
		},
		...
		["loc_trait_bespoke_toughness_on_continuous_fire_alternative_desc"] = { -- toughness: +4%, ammo: 10%, stacks: 5, +colors
			...
			-- fr = CNumb("{toughness:%s}", "tghns_var_rgb").." de "..CKWord("", "Toughness_rgb_fr").." pour chaque tir lors d'un tir continu. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			...
			-- ["zh-cn"] = "连续射击期间，每次射击回复"..CKWord("", "Toughness_rgb_zh_cn")..",\n每叠加 "..CNumb("1", "n_1_rgb").." 层，"..CKWord("", "Toughness_rgb_zh_cn").."回复效果 "..CNumb("{toughness:%s}", "tghns_var_rgb").."。\n最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。", -- 鼓舞弹幕
		},
		--[+ EXPANSIVE +]--
		-- Melee Power (per tier)
		...
		["loc_trait_bespoke_weapon_special_power_bonus_after_one_shots_desc"] = { -- power_level: +42%, time: 3.5, s->seconds, +colors
			en = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." Melee "..CKWord("Strength", "Strength_rgb").." for "..CNumb("{time:%s}", "time_var_rgb").." seconds on Hitting "..CNumb("3", "n_3_rgb")..CKWord("+", "n_plus_rgb").." Enemies with a Ranged Attack.\n"
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
			...
			-- fr = CNumb("{power_level:%s}", "pwrlvl_var_rgb").." de "..CKWord("", "Strength_rgb_fr").." de mélée pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes en touchant au moins "..CNumb("3", "n_3_rgb").." ennemies avec une attaque à distance."..CNote("Pwr_note_rgb_fr"),
			-- ["zh-tw"] = "遠程攻擊同時命中 "..CNumb("3", "n_3_rgb").." 名以上敵人\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("Strength_m", "Strength_m_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。" .. COLORS_KWords_tw.CNote("Pwr_note_rgb_tw"), -- 擴展性
				-- 反衝者 -- 30% | 34% | 38% | 42%
			-- ["zh-cn"] = "命中至少 "..CNumb("3", "n_3_rgb").." 名敌人时\n"..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近战"..CKWord("", "Strength_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Pwr_note_rgb_zh_cn"), -- 扩展
		},
		--[+ SHRAPNEL +]--
		-- Bleed Stacks (per tier)
		-- Rumbler -- 1 | 2 | 3 | 4
		["loc_trait_bespoke_close_explosion_applies_bleed_desc"] = { -- stacks: 4, +colors
			...
			-- fr = CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CKWord("", "Bleed_rgb_fr").." avec les explosions rapprochées.",
			-- ["zh-tw"] = CNumb("12.5", "n_12_5_rgb").." 公尺內的爆炸會施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("Bleed", "Bleed_rgb_tw").."。", -- 破片四射
				-- 震盪槍 -- 1 | 2 | 3 | 4
			-- ["zh-cn"] = "低吼者的榴弹爆炸中心范围 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CKWord("", "Bleed_rgb_zh_cn").."。", -- 弹片
		},
		--[+ BLAST ZONE +]--
		...
		["loc_trait_bespoke_weakspot_projectile_hit_increases_reload_speed_desc"] = { -- reload_speed: +30%, duration: 3, +colors
			...
			-- fr = CNumb("{reload_speed:%s}", "reload_var_rgb").." de vitesse de rechargement pendant "..CNumb("{duration:%s}", "dur_var_rgb").." secondes lors d'un "..CKWord("", "Weakspothit_rgb_fr")..".",
