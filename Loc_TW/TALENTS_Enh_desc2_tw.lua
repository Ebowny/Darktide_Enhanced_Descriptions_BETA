...
local doesnt_stack_w_z_same_aura_ogr = Arrow_right_.." 無法與其他歐格林的相同光環疊加。"
...
local this_also_buffs_melee_sp_act_guns = Arrow_right_.." 也會增加以下武器的特殊近戰動作：\n"..Arrow_right_.." 全自動霰彈槍、擲彈兵臂鎧(近戰)、\n"..Arrow_right_.." 震盪槍、雙鏈重型機槍及反衝者。"
...
--[+ +BLITZ+ +]--
	...
	local ED_OGR_Blitz_0_rgb_tw = iu_actit(table.concat({
		"",
		Arrow_right_.." 衝擊基礎傷害：1850 。",
		"",
		Arrow_up_green.." 衝擊傷害可以秒殺的敵人：",
		Arrow_right_.." 砲手、霰彈槍手、渣滓狂怒者、重錘兵",
		Arrow_right_.." 變種人、瘟疫獵犬、瘟疫爆者、腐化者",
	}, "\n"), enhdesc_col)

	local ED_OGR_Blitz_1_rgb_tw = iu_actit(table.concat({
		"",
		Arrow_right_.." 衝擊基礎傷害：1200 。",
		"",
		Arrow_up_green.." 衝擊傷害可以秒殺的敵人：",
		Arrow_right_.." 砲手、霰彈槍手、渣滓狂怒者、變種人",
		Arrow_right_.." 瘟疫獵犬、瘟疫爆者、腐化者。",
		Arrow_down_red.." 無法秒殺：重錘兵、歐格林、巨獸。",
		Arrow_up_green.." 衝擊傷害的加成來源：撕裂、脆弱。",

		"",
		Arrow_right_.." 以下效果可提升傷害：",
		Arrow_right_.." 「碎顱者」（敵人踉蹌時）、",
		Arrow_right_.." 「重量級」（針對歐格林）、",
		Arrow_right_.." 「報復時間」、「換彈完畢」、",
		Arrow_right_.." 「削弱敵人」（由隊友歐格林施加）、",
		Arrow_right_.." 「重要干擾」、小型遠程傷害節點。",

		"",
		Arrow_up_green.." 攻擊對所有敵人造成踉蹌。",
		Arrow_right_.." 巨獸、雙子，需命中弱點才會踉蹌。",
		Arrow_right_.." 且雙子須無盾狀態下才生效。",

		"",
		Arrow_right_.." 攻擊無順劈效果，",
		Arrow_right_.." 巨石可能碰撞後彈回。",
		Arrow_right_.." 彈回時可對第二個敵人造成傷害。",
	}, "\n"), enhdesc_col)
	...
	local ED_OGR_Blitz_2_rgb_tw = iu_actit(table.concat({
		...
		"",
		Arrow_right_.." 破片手榴彈：",
		Arrow_right_.." 爆炸中心半徑為 "..COLORS_Numbers.n_2_rgb..COLORS_Numbers.n_meter_rgb.."。",
		Arrow_right_.." 最遠波及範圍為 "..COLORS_Numbers.n_8_rgb..COLORS_Numbers.n_meter_rgb.."。",
		Arrow_up_green.." 在爆心可對所有敵人造成踉蹌。",
		Arrow_right_.." 含巨獸與雙子(需無盾)。",
		"",
		Arrow_right_.." 衝擊基礎傷害：1850 。",
		Arrow_up_green.." 對不屈敵人 "..COLORS_KWords_tw.Dmg_h_rgb_tw.."。\n",
		Arrow_down_red.." 對甲殼敵人低 "..COLORS_KWords_tw.Dmg_rgb_tw.."。\n",
		Arrow_up_green.." 衝擊傷害的加成來源：撕裂、脆弱。",
		Arrow_right_.." 以下效果可提升傷害：",
		Arrow_right_.." 「碎顱者」、「重量級」。",
		Arrow_right_.." 「報復時間」、「換彈完畢」。",
		Arrow_right_.." 「削弱敵人」、「重要干擾」。",
	}, "\n"), enhdesc_col)
	...
	local ED_OGR_Blitz_3_rgb_tw = iu_actit(table.concat({
		"",
		Arrow_right_.." 引信延遲為 "..COLORS_Numbers.n_2_rgb..COLORS_Numbers.n_second_rgb.."。",
		"",
		Arrow_right_.." 爆炸範圍：",
		Arrow_right_.." 爆心半徑為 "..COLORS_Numbers.n_2_rgb..COLORS_Numbers.n_meter_rgb.."。",
		Arrow_right_.." 最大範圍為 "..COLORS_Numbers.n_16_rgb..COLORS_Numbers.n_meter_rgb.."。",
		"",
		Arrow_right_.." 爆炸傷害：",
		Arrow_up_green.." 爆心傷害為 1500 。",
		Arrow_up_green.." 外區域傷害為 1250 。",
		Arrow_up_green.." 無法秒殺以下敵人：",
		Arrow_right_.." 重錘兵、碾壓者、堡壘、巨獸。",
		Arrow_up_green.." 對所有護甲皆有效。",
		Arrow_right_.." 防彈、狂熱者、不屈較果較佳。",

		"",
		Arrow_up_green.." 可獲得以下加成：",
		Arrow_right_.." 撕裂、脆弱效果。",
		Arrow_right_.." 「碎顱者」（敵人踉蹌時）。",
		Arrow_right_.." 「重量級」、「報復時間」、",
		Arrow_right_.." 「削弱敵人」、「重要干擾」。",

		"",
		Arrow_up_green.." 對所有敵人造成高額踉蹌。",
		Arrow_right_.." 包含巨獸與血痂雙子。",
		Arrow_right_.." 雙子需無盾狀態下才生效。",
	}, "\n"), enhdesc_col)

	--[+ Aura 0 - Intimidating Presence +]--
	local ED_OGR_Aura_0_rgb_tw = iu_actit(table.concat({
		"",
		-- "- 可與其他傷害增幅效果疊加，並與武器祝福提供的威能加成乘算。",
		Arrow_right_.." 與其他傷害增幅增益以加法疊加。",
		Arrow_right_.." 與其他武器祝福的威力以乘法疊加。",
	...
	local ED_OGR_Aura_2_rgb_tw = iu_actit(table.concat({
		...
		"_______________________________",
		"",
		Arrow_right_.." 韌性恢復為加法疊加：",
		Arrow_right_.." 包含「關鍵人物」。",
		Arrow_right_.." 鑰石「麻木」（含最堅韌）。",
		Arrow_right_.." 珍品提供的韌性恢復速度。",
		Arrow_right_.." 老兵小天賦「鼓舞人心」。",
	...
	local ED_OGR_Aura_3_rgb_tw = iu_actit(table.concat({
		"",
		Arrow_right_.." 與「持續阻擊」為加法疊加。",
		Arrow_right_.." 與武器祝福的威力乘法疊加。",
		doesnt_stack_w_z_same_aura_ogr,
		"",
		Arrow_right_.." 可被壓制的敵人包含：",
		Arrow_right_.." 低階感染者、渣滓砲手、",
		Arrow_right_.." 渣滓伏擊兵、收割者、",
		Arrow_right_.." 血痂砲手、血痂射手、",
		Arrow_right_.." 血痂伏擊兵。",
	}, "\n"), enhdesc_col)
